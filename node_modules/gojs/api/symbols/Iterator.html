...
<html>
    <head>
        ...
        <title>GoJS&reg; Iterator Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class Iterator.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>This is an interface and thus does not have a constructor.
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class Iterator.">
                    <thead>
                        <tr>
              ...
              <tr id="count" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property is the total number of items in the iterated collection.
              ...
              <tr id="iterator" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Returns itself, which is convenient for code that expects an <a href="../symbols/Iterable.html" class="linkConstructor">Iterable</a>instead of an <a href="../symbols/Iterator.html" class="linkConstructor">Iterator</a>.
              ...
              <tr id="key" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets the current index to the item in the collection, assuming <a href="../symbols/Iterator.html#next" class="linkMethod">next</a> has just returned true.
              ...
              <tr id="value" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets the current item in the collection, assuming <a href="../symbols/Iterator.html#next" class="linkMethod">next</a> has just returned true.
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class Iterator.">
                    <thead>
                        <tr>
            ...
            <tr id="each">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Call the given function on each item in the collection.<span class="nodetails" id="xmetheach"><a class="morelink" onclick="hst('metheach')">More...</a></span> <span class="details" id="metheach"></span><div class="details" id="dmetheach"><p>This automatically <a href="../symbols/Iterator.html#reset" class="linkMethod">reset</a>'s itself when it is called.</div>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{Iterator.<T>}</span> this iterator itself</dt>
            ...
            <tr id="first">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Advance if needed to the first item in the collection and return it, or return null if there is none.<span class="nodetails" id="xmethfirst"><a class="morelink" onclick="hst('methfirst')">More...</a></span> <span class="details" id="methfirst"></span><div class="details" id="dmethfirst"><p>Caution: this returns a <i>key/value pair</i>, not a <i>value</i>, for <a href="../symbols/Map.html" class="linkConstructor">Map</a> iterators.</div>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{T|null}</span> </dt>
            ...
            <tr id="next">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Call this method to advance the iterator to the next item in the collection.<span class="nodetails" id="xmethnext"><a class="morelink" onclick="hst('methnext')">More...</a></span> <span class="details" id="methnext">This should be called before accessing any <a href="../symbols/Iterator.html#value" class="linkProperty">value</a>.</span>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{boolean}</span> whether another item is available; when true the value of <a href="../symbols/Iterator.html#value" class="linkProperty">value</a> will be that item.</dt>
            ...
            <tr id="reset">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Start this iterator all over again.
