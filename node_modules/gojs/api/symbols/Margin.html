...
<html>
    <head>
        ...
        <title>GoJS&reg; Margin Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class Margin.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>If zero arguments are supplied, zero is used for all four sides.<span class="nodetails" id="xconMargin"><a class="morelink" onclick="hst('conMargin')">More...</a></span> <span class="details" id="conMargin">If one argument is supplied, that number is used for all four sides.If two arguments are supplied, the top and bottom sides get the first value,and the left and right sides get the second value.Otherwise there must be four arguments, in the order: top, right, bottom, left.</span>
                            ...
                            <dt class="heading">Parameters:</dt>
                                ...
                                <dt>
                                    ...
                                    <dd>the margin for the top side;                   if not supplied, all sides are zero.</dd>
                            
                                <dt>
                                    <span class="light fixedFont">{number=}</span>  <b>r</b>
                                    
                                </dt>
                                    <dd>the margin for the right side;                   if not supplied, all sides have the value of the first argument.</dd>
                            
                                <dt>
                                    <span class="light fixedFont">{number=}</span>  <b>b</b>
                                    
                                </dt>
                                    <dd>the margin for all bottom side;                   if not supplied, the top and bottom get the value of the first argument,                   and the right and left sides get the value of the second argument.</dd>
                            
                                <dt>
                                    <span class="light fixedFont">{number=}</span>  <b>l</b>
                                    
                                </dt>
                                    <dd>the margin for the left side;                   must be supplied if the third argument was supplied.</dd>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class Margin.">
                    <thead>
                        <tr>
              ...
              <tr id="bottom" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the bottom value of this margin.<span class="nodetails" id="xpropbottom"><a class="morelink" onclick="hst('propbottom')">More...</a></span> <span class="details" id="propbottom"> Default is 0.</span>
              ...
              <tr id="left" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the left value of this margin.<span class="nodetails" id="xpropleft"><a class="morelink" onclick="hst('propleft')">More...</a></span> <span class="details" id="propleft"> Default is 0.</span>
              ...
              <tr id="right" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the right value of this margin.<span class="nodetails" id="xpropright"><a class="morelink" onclick="hst('propright')">More...</a></span> <span class="details" id="propright"> Default is 0.</span>
              ...
              <tr id="top" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the top value of this margin.<span class="nodetails" id="xproptop"><a class="morelink" onclick="hst('proptop')">More...</a></span> <span class="details" id="proptop"> Default is 0.</span>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class Margin.">
                    <thead>
                        <tr>
            ...
            <tr id="copy">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Create a copy of this Margin, with the same values.
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{<a href="../symbols/Margin.html" class="linkConstructor">Margin</a>}</span> </dt>
            ...
            <tr id="equals">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Indicates whether the given Margin is equal to this Margin.<span class="nodetails" id="xmethequals"><a class="morelink" onclick="hst('methequals')">More...</a></span> <span class="details" id="methequals"></span>
                 
                                </p><div class="seealso">See also:
                  <ul class="seealsolist">
                                  
                                    <li><a href="../symbols/Margin.html#equalTo" class="linkMethod">equalTo</a></li>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dd>The Margin to compare to this Margin.</dd>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{boolean}</span> True if the two Margins have identical Top and Right and Bottom and Left values,false otherwise.</dt>
            ...
            <tr id="equalTo">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Indicates whether the given margin is equal to this Margin.<span class="nodetails" id="xmethequalTo"><a class="morelink" onclick="hst('methequalTo')">More...</a></span> <span class="details" id="methequalTo"></span>
                 
                                </p><div class="seealso">See also:
                  <ul class="seealsolist">
                                  
                                    <li><a href="../symbols/Margin.html#equals" class="linkMethod">equals</a></li>
            ...
            <tr id="isReal">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>True if this Margin has values that are real numbers and not infinity.
            ...
            <tr id=".parse">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This static function can be used to read in a <a href="../symbols/Margin.html" class="linkConstructor">Margin</a> from a string that was produced by <a href="../symbols/Margin.html#.stringify" class="linkStatic">Margin.stringify</a>.<span class="nodetails" id="xmethparse"><a class="morelink" onclick="hst('methparse')">More...</a></span> <span class="details" id="methparse"></span><div class="details" id="dmethparse"><p><code>go.Margin.parse("1 2 3 4")</code> produces the Margin <code>new go.Margin(1, 2, 3, 4)</code>.</div>
            ...
            <tr id="set">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Modify this Margin so that its Top, Right, Bottom, and Left valuesare the same as the given Margin.<span class="nodetails" id="xmethset"><a class="morelink" onclick="hst('methset')">More...</a></span> <span class="details" id="methset"></span>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{<a href="../symbols/Margin.html" class="linkConstructor">Margin</a>}</span> this.</dt>
            ...
            <tr id="setTo">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Modify this Margin with new Top, Right, Bottom, and Left values.<span class="nodetails" id="xmethsetTo"><a class="morelink" onclick="hst('methsetTo')">More...</a></span> <span class="details" id="methsetTo"></span>
            ...
            <tr id=".stringify">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This static function can be used to write out a <a href="../symbols/Margin.html" class="linkConstructor">Margin</a> as a string that can be read by <a href="../symbols/Margin.html#.parse" class="linkStatic">Margin.parse</a>.<span class="nodetails" id="xmethstringify"><a class="morelink" onclick="hst('methstringify')">More...</a></span> <span class="details" id="methstringify"></span><div class="details" id="dmethstringify"><p><code>go.Margin.stringify(new go.Margin(1, 2, 3, 4))</code> produces the string "1 2 3 4".</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{<a href="../symbols/Margin.html" class="linkConstructor">Margin</a>}</span> <b>val</b>
