...
<html>
    <head>
        ...
        <title>GoJS&reg; LayeredDigraphEdge Class</title>
        ...
        <span class="details"><button id="buttonHide">Show Summaries</button></span>
            ...
            <p class="classsummary">
                ...
                <span class="extends"> Extends
                    <a href="../symbols/LayoutEdge.html" class="linkConstructor">LayoutEdge</a>.</span>
                

                This holds <a href="../symbols/LayeredDigraphLayout.html" class="linkConstructor">LayeredDigraphLayout</a>-specific information about <a href="../symbols/Link.html" class="linkConstructor">Link</a>s.<p>This class inherits from <a href="../symbols/LayoutEdge.html" class="linkConstructor">LayoutEdge</a>.
            </p>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class LayeredDigraphEdge.">
                <thead>
                        <tr>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class LayeredDigraphEdge.">
                    <thead>
                        <tr>
              ...
              <tr id="forest" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>True if the link is part of the depth first forest.<span class="nodetails" id="xpropforest"><a class="morelink" onclick="hst('propforest')">More...</a></span> <span class="details" id="propforest">The default value is false.</span>
                
                </div>
                            </td>
                        </tr>
                    
              <tr id="portFromColOffset" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Approximate column offset of the from port of the link from the from node column used in straightening.<span class="nodetails" id="xpropportFromColOffset"><a class="morelink" onclick="hst('propportFromColOffset')">More...</a></span> <span class="details" id="propportFromColOffset">The default value is 0.</span>
              ...
              <tr id="portFromPos" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Location of the port at the from node of the link.<span class="nodetails" id="xpropportFromPos"><a class="morelink" onclick="hst('propportFromPos')">More...</a></span> <span class="details" id="propportFromPos">Allows the crossing matrix to correctly calculate the crossings for nodes with multiple ports.The default value is NaN.</span>
                
                </div>
                            </td>
                        </tr>
                    
              <tr id="portToColOffset" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Approximate column offset of the to port of the link from the to node column used in straightening.<span class="nodetails" id="xpropportToColOffset"><a class="morelink" onclick="hst('propportToColOffset')">More...</a></span> <span class="details" id="propportToColOffset">The default value is 0.</span>
              ...
              <tr id="portToPos" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Location of the port at the to node of the link.<span class="nodetails" id="xpropportToPos"><a class="morelink" onclick="hst('propportToPos')">More...</a></span> <span class="details" id="propportToPos">Allows the crossing matrix to correctly calculate the crossings for nodes with multiple ports.The default value is NaN.</span>
              ...
              <tr id="rev" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>True if the link was reversed during cycle removal.<span class="nodetails" id="xproprev"><a class="morelink" onclick="hst('proprev')">More...</a></span> <span class="details" id="proprev">The default value is false.</span>
              ...
              <tr id="valid" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>True if the link is part of the proper digraph.<span class="nodetails" id="xpropvalid"><a class="morelink" onclick="hst('propvalid')">More...</a></span> <span class="details" id="propvalid">The default value is false.</span>
                ...
                <dt>Properties borrowed from class <a href="../symbols/LayoutEdge.html" class="linkConstructor">LayoutEdge</a>: </dt><dd><a href="../symbols/LayoutEdge.html#data" class="linkProperty">data</a>, <a href="../symbols/LayoutEdge.html#fromVertex" class="linkProperty">fromVertex</a>, <a href="../symbols/LayoutEdge.html#link" class="linkProperty">link</a>, <a href="../symbols/LayoutEdge.html#network" class="linkProperty">network</a>, <a href="../symbols/LayoutEdge.html#toVertex" class="linkProperty">toVertex</a></dd>
                </dl>
...
<!-- ============================== methods summary ======================== -->
                ...
                <dl class="inheritsList">
                <dt>Methods borrowed from class <a href="../symbols/LayoutEdge.html" class="linkConstructor">LayoutEdge</a>: </dt><dd><a href="../symbols/LayoutEdge.html#commit" class="linkMethod">commit</a>, <a href="../symbols/LayoutEdge.html#getOtherVertex" class="linkMethod">getOtherVertex</a></dd>
                </dl>
