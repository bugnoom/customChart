...
<html>
    <head>
        ...
        <title>GoJS&reg; HTMLInfo Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class HTMLInfo.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>A newly constructed HTMLInfo can be assigned as a value of <a href="../symbols/TextEditingTool.html#defaultTextEditor" class="linkProperty">TextEditingTool.defaultTextEditor</a>, <a href="../symbols/TextBlock.html#textEditor" class="linkProperty">TextBlock.textEditor</a><a href="../symbols/GraphObject.html#contextMenu" class="linkProperty">GraphObject.contextMenu</a>, <a href="../symbols/Diagram.html#contextMenu" class="linkProperty">Diagram.contextMenu</a>, <a href="../symbols/GraphObject.html#toolTip" class="linkProperty">GraphObject.toolTip</a>, or <a href="../symbols/Diagram.html#toolTip" class="linkProperty">Diagram.toolTip</a>.
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class HTMLInfo.">
                    <thead>
                        <tr>
              ...
              <tr id="hide" >
                ...
                <td class="name">
                  ...
                  <div class="attributes">
                    <span class="light">{function(Diagram, Tool) | null}</span>
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the function to call when an HTMLInfo is to be hidden.<span class="nodetails" id="xprophide"><a class="morelink" onclick="hst('prophide')">More...</a></span> <span class="details" id="prophide">The function should "hide" the HTMLInfo, either by removing any traces of it or otherwisereturning the page state to one where the HTMLInfo content is no longer considered active.</span><div class="details" id="dprophide"><p>Setting this is not strictly necessary, if no action is to be taken when hiding the HTMLInfo.<p>If this is called by:<ul><li><a href="../symbols/ContextMenuTool.html#hideContextMenu" class="linkMethod">ContextMenuTool.hideContextMenu</a>, the second argument is the <a href="../symbols/ContextMenuTool.html" class="linkConstructor">ContextMenuTool</a>.</li><li><a href="../symbols/ToolManager.html#hideToolTip" class="linkMethod">ToolManager.hideToolTip</a>, the second argument is the <a href="../symbols/ToolManager.html" class="linkConstructor">ToolManager</a>.</li><li><a href="../symbols/TextEditingTool.html#doDeactivate" class="linkMethod">TextEditingTool.doDeactivate</a>, the second argument is the <a href="../symbols/TextEditingTool.html" class="linkConstructor">TextEditingTool</a>.</li><ul></div>
                
                    <div class="seealso">See also:
                        <ul class="seealsolist">
                            
                                <li><a href="../symbols/HTMLInfo.html#mainElement" class="linkProperty">mainElement</a></li>
              ...
              <tr id="mainElement" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the primary HTML Element that represents this HTMLInfo.<span class="nodetails" id="xpropmainElement"><a class="morelink" onclick="hst('propmainElement')">More...</a></span> <span class="details" id="propmainElement">In a context menu, this would be the outermost HTML element, the one which typicallyshows and hides. If this is set and <a href="../symbols/HTMLInfo.html#hide" class="linkProperty">hide</a> is not, HTMLInfo will automatically execute:<pre>  tool.mainElement.style.display = "none";</pre></span><div class="details" id="dpropmainElement"><p>when <a href="../symbols/HTMLInfo.html#hide" class="linkProperty">hide</a> would typically be called.<p>This is set only for convenience; the default value for this property is null.</div>
                
                    <div class="seealso">See also:
                        <ul class="seealsolist">
                            
                                <li><a href="../symbols/HTMLInfo.html#hide" class="linkProperty">hide</a></li>
              ...
              <tr id="show" >
                ...
                <td class="name">
                  ...
                  <div class="attributes">
                    <span class="light">{function(GraphObject, Diagram, Tool) | null}</span>
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the function to call when an HTMLInfo is to be shown,such as when used as the <a href="../symbols/GraphObject.html#contextMenu" class="linkProperty">GraphObject.contextMenu</a> or <a href="../symbols/Diagram.html#toolTip" class="linkProperty">Diagram.toolTip</a> or <a href="../symbols/TextBlock.html#textEditor" class="linkProperty">TextBlock.textEditor</a>.<span class="nodetails" id="xpropshow"><a class="morelink" onclick="hst('propshow')">More...</a></span> <span class="details" id="propshow"></span><div class="details" id="dpropshow"><p>If this is called by:<ul><li><a href="../symbols/ContextMenuTool.html#showContextMenu" class="linkMethod">ContextMenuTool.showContextMenu</a>, the first argument is the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> for which the context menu is being shown, or null for the diagram background.</li><li><a href="../symbols/ToolManager.html#showToolTip" class="linkMethod">ToolManager.showToolTip</a>, the first argument is the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> for which the tooltip is being shown, or null for the diagram background.</li><li><a href="../symbols/TextEditingTool.html#doActivate" class="linkMethod">TextEditingTool.doActivate</a>, the first argument is the <a href="../symbols/TextBlock.html" class="linkConstructor">TextBlock</a> for which the text editor is being shown.</li><ul><p>If you need access to any bound data for the first argument, if it is non-null, you can get it via:<code>obj.part.data</code>and then you can look at any of the properties you have put on that data.<p>When used as a context menu, typically shown elements, such as buttons, should call<code>diagram.currentTool.stopTool();</code> when their action is completed.</div>
              ...
              <tr id="valueFunction" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets a function that returns the primary value associated with this HTMLInfo,such as the string value of a text editor, which would be solicited by the <a href="../symbols/TextEditingTool.html" class="linkConstructor">TextEditingTool</a>.<span class="nodetails" id="xpropvalueFunction"><a class="morelink" onclick="hst('propvalueFunction')">More...</a></span> <span class="details" id="propvalueFunction"></span><div class="details" id="dpropvalueFunction"><p>This typically returns a string.</div>
