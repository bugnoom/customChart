...
<html>
    <head>
        ...
        <title>GoJS&reg; ClickCreatingTool Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class ClickCreatingTool.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>You do not normally need to create an instance of this toolbecause one already exists as the <a href="../symbols/ToolManager.html#clickCreatingTool" class="linkProperty">ToolManager.clickCreatingTool</a>, which you can modify.<span class="nodetails" id="xconClickCreatingTool"><a class="morelink" onclick="hst('conClickCreatingTool')">More...</a></span> <span class="details" id="conClickCreatingTool"></span><div class="details" id="dconClickCreatingTool"><p>The <a href="../symbols/Tool.html#name" class="linkProperty">Tool.name</a> of this tool is "ClickCreating".</div>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class ClickCreatingTool.">
                    <thead>
                        <tr>
              ...
              <tr id="archetypeNodeData" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets a data object that will be copied and added to the diagram's model each time this tool executes.<span class="nodetails" id="xproparchetypeNodeData"><a class="morelink" onclick="hst('proparchetypeNodeData')">More...</a></span> <span class="details" id="proparchetypeNodeData">The default value is null.The value must be non-null for this tool to be able to run.Setting this property does not raise any events.</span>
              ...
              <tr id="isDoubleClick" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets whether a double click rather than a single-click is requiredto insert a new <a href="../symbols/Part.html" class="linkConstructor">Part</a> at the mouse-up point.<span class="nodetails" id="xpropisDoubleClick"><a class="morelink" onclick="hst('propisDoubleClick')">More...</a></span> <span class="details" id="propisDoubleClick">The default value is true -- only a double-click will cause a node to be created.Setting this property does not raise any events.</span>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class ClickCreatingTool.">
                    <thead>
                        <tr>
            ...
            <tr id="canStart">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This tool can run when the diagram is not read-only and supports creating new nodes,and when there has been a click (or double-click if <a href="../symbols/ClickCreatingTool.html#isDoubleClick" class="linkProperty">isDoubleClick</a> is true)in the background of the diagram (not on a <a href="../symbols/Part.html" class="linkConstructor">Part</a>),and <a href="../symbols/ClickCreatingTool.html#archetypeNodeData" class="linkProperty">archetypeNodeData</a> is an object that can be copied and added to the model.<span class="nodetails" id="xmethcanStart"><a class="morelink" onclick="hst('methcanStart')">More...</a></span> <span class="details" id="methcanStart"></span><div class="details" id="dmethcanStart"><p>This method may be overridden.</div>
            ...
            <tr id="doMouseUp">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Upon a click, call <a href="../symbols/ClickCreatingTool.html#insertPart" class="linkMethod">insertPart</a> and stop this tool.
            ...
            <tr id="insertPart">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Create a node by adding a copy of the <a href="../symbols/ClickCreatingTool.html#archetypeNodeData" class="linkProperty">archetypeNodeData</a> objectto the diagram's model, assign its <a href="../symbols/Part.html#location" class="linkProperty">Part.location</a>to be the given point, and select the new part.<span class="nodetails" id="xmethinsertPart"><a class="morelink" onclick="hst('methinsertPart')">More...</a></span> <span class="details" id="methinsertPart"></span><div class="details" id="dmethinsertPart"><p>This starts and commits a transaction and also raises the "PartCreated" <a href="../symbols/DiagramEvent.html" class="linkConstructor">DiagramEvent</a>.The actual part that is added to the diagram may be a <a href="../symbols/Part.html" class="linkConstructor">Part</a>, a <a href="../symbols/Node.html" class="linkConstructor">Node</a>,or even a <a href="../symbols/Group.html" class="linkConstructor">Group</a>, depending on the properties of the <a href="../symbols/ClickCreatingTool.html#archetypeNodeData" class="linkProperty">archetypeNodeData</a>and the type of the template that is copied to create the part.<p>This method may be overridden, although it is usually much easier to just set <a href="../symbols/ClickCreatingTool.html#archetypeNodeData" class="linkProperty">archetypeNodeData</a>.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{<a href="../symbols/Point.html" class="linkConstructor">Point</a>}</span> <b>loc</b>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{<a href="../symbols/Part.html" class="linkConstructor">Part</a>}</span> the newly created Part, or null if it failed.</dt>
                ...
                <dl class="inheritsList">
                <dt>Methods borrowed from class <a href="../symbols/Tool.html" class="linkConstructor">Tool</a>: </dt><dd><a href="../symbols/Tool.html#cancelWaitAfter" class="linkMethod">cancelWaitAfter</a>, <a href="../symbols/Tool.html#canStartMultiTouch" class="linkMethod">canStartMultiTouch</a>, <a href="../symbols/Tool.html#doActivate" class="linkMethod">doActivate</a>, <a href="../symbols/Tool.html#doCancel" class="linkMethod">doCancel</a>, <a href="../symbols/Tool.html#doDeactivate" class="linkMethod">doDeactivate</a>, <a href="../symbols/Tool.html#doKeyDown" class="linkMethod">doKeyDown</a>, <a href="../symbols/Tool.html#doKeyUp" class="linkMethod">doKeyUp</a>, <a href="../symbols/Tool.html#doMouseDown" class="linkMethod">doMouseDown</a>, <a href="../symbols/Tool.html#doMouseMove" class="linkMethod">doMouseMove</a>, <a href="../symbols/Tool.html#doMouseWheel" class="linkMethod">doMouseWheel</a>, <a href="../symbols/Tool.html#doStart" class="linkMethod">doStart</a>, <a href="../symbols/Tool.html#doStop" class="linkMethod">doStop</a>, <a href="../symbols/Tool.html#doWaitAfter" class="linkMethod">doWaitAfter</a>, <a href="../symbols/Tool.html#findToolHandleAt" class="linkMethod">findToolHandleAt</a>, <a href="../symbols/Tool.html#isBeyondDragSize" class="linkMethod">isBeyondDragSize</a>, <a href="../symbols/Tool.html#standardMouseClick" class="linkMethod">standardMouseClick</a>, <a href="../symbols/Tool.html#standardMouseOver" class="linkMethod">standardMouseOver</a>, <a href="../symbols/Tool.html#standardMouseSelect" class="linkMethod">standardMouseSelect</a>, <a href="../symbols/Tool.html#standardMouseWheel" class="linkMethod">standardMouseWheel</a>, <a href="../symbols/Tool.html#standardPinchZoomMove" class="linkMethod">standardPinchZoomMove</a>, <a href="../symbols/Tool.html#standardPinchZoomStart" class="linkMethod">standardPinchZoomStart</a>, <a href="../symbols/Tool.html#standardWaitAfter" class="linkMethod">standardWaitAfter</a>, <a href="../symbols/Tool.html#startTransaction" class="linkMethod">startTransaction</a>, <a href="../symbols/Tool.html#stopTool" class="linkMethod">stopTool</a>, <a href="../symbols/Tool.html#stopTransaction" class="linkMethod">stopTransaction</a>, <a href="../symbols/Tool.html#updateAdornments" class="linkMethod">updateAdornments</a></dd>
                </dl>
