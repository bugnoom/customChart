...
<html>
    <head>
        ...
        <title>GoJS&reg; RelinkingTool Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class RelinkingTool.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>You do not normally need to create an instance of this toolbecause one already exists as the <a href="../symbols/ToolManager.html#relinkingTool" class="linkProperty">ToolManager.relinkingTool</a>, which you can modify.<span class="nodetails" id="xconRelinkingTool"><a class="morelink" onclick="hst('conRelinkingTool')">More...</a></span> <span class="details" id="conRelinkingTool"></span><div class="details" id="dconRelinkingTool"><p>The <a href="../symbols/Tool.html#name" class="linkProperty">Tool.name</a> of this tool is "Relinking".</div>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class RelinkingTool.">
                    <thead>
                        <tr>
              ...
              <tr id="fromHandleArchetype" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets a small GraphObject that is copied as a relinking handle for the selected link pathat the "from" end of the link.<span class="nodetails" id="xpropfromHandleArchetype"><a class="morelink" onclick="hst('propfromHandleArchetype')">More...</a></span> <span class="details" id="propfromHandleArchetype">By default this is a <a href="../symbols/Shape.html" class="linkConstructor">Shape</a> that is a small blue diamond.Setting this property does not raise any events.</span><div class="details" id="dpropfromHandleArchetype"><p>Here is an example of changing the default handle to be larger green triangles:<pre class="javascript">myDiagram.toolManager.relinkingTool.toHandleArchetype =  $(go.Shape, "Triangle",    { width: 10, height: 10, fill: "limegreen", segmentIndex: 0 });</pre></div>
                
                    <div class="seealso">See also:
                        <ul class="seealsolist">
                            
                                <li><a href="../symbols/RelinkingTool.html#toHandleArchetype" class="linkProperty">toHandleArchetype</a></li>
              ...
              <tr id="handle" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property returns the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> that is the tool handle being dragged by the user.<span class="nodetails" id="xprophandle"><a class="morelink" onclick="hst('prophandle')">More...</a></span> <span class="details" id="prophandle">This will be contained by an <a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a> whose category is "RelinkFrom" or "RelinkTo".Its <a href="../symbols/Adornment.html#adornedPart" class="linkProperty">Adornment.adornedPart</a> is the same as the <a href="../symbols/LinkingBaseTool.html#originalLink" class="linkProperty">originalLink</a>.</span>
                
                </div>
                            </td>
                        </tr>
                    
              <tr id="toHandleArchetype" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets a small GraphObject that is copied as a relinking handle for the selected link pathat the "to" end of the link.<span class="nodetails" id="xproptoHandleArchetype"><a class="morelink" onclick="hst('proptoHandleArchetype')">More...</a></span> <span class="details" id="proptoHandleArchetype">By default this is a <a href="../symbols/Shape.html" class="linkConstructor">Shape</a> that is a small blue diamond.Setting this property does not raise any events.</span><div class="details" id="dproptoHandleArchetype"><p>Here is an example of changing the default handle to be larger orange triangles:<pre class="javascript">  myDiagram.toolManager.relinkingTool.toHandleArchetype =  $(go.Shape, "Triangle",    { width: 10, height: 10, fill: "orange", segmentIndex: -1 });</pre></div>
                
                    <div class="seealso">See also:
                        <ul class="seealsolist">
                            
                                <li><a href="../symbols/RelinkingTool.html#fromHandleArchetype" class="linkProperty">fromHandleArchetype</a></li>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class RelinkingTool.">
                    <thead>
                        <tr>
            ...
            <tr id="canStart">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This tool can run when the diagram allows relinking, the model is modifiable,and there is a relink handle at the mouse-down point.<span class="nodetails" id="xmethcanStart"><a class="morelink" onclick="hst('methcanStart')">More...</a></span> <span class="details" id="methcanStart"></span><div class="details" id="dmethcanStart"><p>This method may be overridden, but we recommend that you call this base method.</div>
            ...
            <tr id="copyLinkProperties">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Make a temporary link look and act like the real Link being relinked.<span class="nodetails" id="xmethcopyLinkProperties"><a class="morelink" onclick="hst('methcopyLinkProperties')">More...</a></span> <span class="details" id="methcopyLinkProperties">By default this method copies many of the routing-oriented propertiesfrom the <a href="../symbols/LinkingBaseTool.html#originalLink" class="linkProperty">LinkingBaseTool.originalLink</a> to the <a href="../symbols/LinkingBaseTool.html#temporaryLink" class="linkProperty">LinkingBaseTool.temporaryLink</a>.</span><div class="details" id="dmethcopyLinkProperties"><p>This method may be overridden, but we recommend that you call this base method.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{<a href="../symbols/Link.html" class="linkConstructor">Link</a>}</span> <b>reallink</b>
                                          
                                      </dt>
                                      <dd></dd>
                                  
                                      <dt>
                                          <span class="light fixedFont">{<a href="../symbols/Link.html" class="linkConstructor">Link</a>}</span> <b>templink</b>
            ...
            <tr id="doActivate">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Start the relinking operation.<span class="nodetails" id="xmethdoActivate"><a class="morelink" onclick="hst('methdoActivate')">More...</a></span> <span class="details" id="methdoActivate"></span><div class="details" id="dmethdoActivate"><p>Find the relink handle by calling <a href="../symbols/Tool.html#findToolHandleAt" class="linkMethod">Tool.findToolHandleAt</a>looking for either the "RelinkFrom" adornment or the "RelinkTo" adornment,saving the result in <a href="../symbols/RelinkingTool.html#handle" class="linkProperty">handle</a>.<p>This starts a transaction, captures the mouse, and sets the cursor.<p>The value of <a href="../symbols/LinkingBaseTool.html#isForwards" class="linkProperty">isForwards</a> is set depending on the category of the relink handle found.The <a href="../symbols/LinkingBaseTool.html#originalLink" class="linkProperty">LinkingBaseTool.originalLink</a> property and various"Original..." port and node properties are set too.The temporary nodes and temporary link are also initialized.<p>This method may be overridden, but we recommend that you call this base method.</div>
            ...
            <tr id="doMouseUp">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>A mouse-up ends the relinking operation; if there is a valid <a href="../symbols/LinkingBaseTool.html#targetPort" class="linkProperty">targetPort</a> nearby,this modifies the old link to connect with the target port.<span class="nodetails" id="xmethdoMouseUp"><a class="morelink" onclick="hst('methdoMouseUp')">More...</a></span> <span class="details" id="methdoMouseUp"></span><div class="details" id="dmethdoMouseUp"><p>A successful relinking calls <a href="../symbols/RelinkingTool.html#reconnectLink" class="linkMethod">reconnectLink</a> to actually change the link.The "LinkRelinked" <a href="../symbols/DiagramEvent.html" class="linkConstructor">DiagramEvent</a> is raised with the link as the <a href="../symbols/DiagramEvent.html#subject" class="linkProperty">DiagramEvent.subject</a>and with the now-disconnected original port as the <a href="../symbols/DiagramEvent.html#parameter" class="linkProperty">DiagramEvent.parameter</a>.If the link was not reconnected, this calls <a href="../symbols/RelinkingTool.html#doNoRelink" class="linkMethod">doNoRelink</a>.In any case this stops the tool.<p>A failure to find a valid target port results in no changes and no DiagramEvent.<p>This method may be overridden, but we recommend that you call this base method.You might find it easier to override <a href="../symbols/RelinkingTool.html#reconnectLink" class="linkMethod">reconnectLink</a>.It is actually most common to implement a "LinkRelinked" <a href="../symbols/DiagramEvent.html" class="linkConstructor">DiagramEvent</a> listener on the <a href="../symbols/Diagram.html" class="linkConstructor">Diagram</a>.</div>
            ...
            <tr id="doNoRelink">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This method is called upon a mouse up when <a href="../symbols/RelinkingTool.html#reconnectLink" class="linkMethod">reconnectLink</a> is not called.<span class="nodetails" id="xmethdoNoRelink"><a class="morelink" onclick="hst('methdoNoRelink')">More...</a></span> <span class="details" id="methdoNoRelink"></span><div class="details" id="dmethdoNoRelink"><p>This method may be overridden.  By default this method does nothing.If you want to successfully perform any side-effects, you will need to set <a href="../symbols/Tool.html#transactionResult" class="linkProperty">Tool.transactionResult</a> to a string;otherwise this tool's transaction will be rolled-back.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{<a href="../symbols/Link.html" class="linkConstructor">Link</a>}</span> <b>existinglink</b>
                                      ...
                                      <dd>If true, the user was trying to modify the link's "to" node and port.</dd>
            ...
            <tr id="reconnectLink">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Modify an existing <a href="../symbols/Link.html" class="linkConstructor">Link</a> to connect to a new node and port.<span class="nodetails" id="xmethreconnectLink"><a class="morelink" onclick="hst('methreconnectLink')">More...</a></span> <span class="details" id="methreconnectLink"></span><div class="details" id="dmethreconnectLink"><p>This method may be overridden, but we recommend that you call this base method.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                 
                                </p><div class="seealso">See also:
                  <ul class="seealsolist">
                                  
                                    <li><a href="../symbols/RelinkingTool.html#doNoRelink" class="linkMethod">doNoRelink</a></li>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{<a href="../symbols/Node.html" class="linkConstructor">Node</a>}</span> <b>newnode</b>
                                          
                                      </dt>
                                      <dd>the <a href="../symbols/Node.html" class="linkConstructor">Node</a> to connect to or from.</dd>
                                  
                                      <dt>
                                          <span class="light fixedFont">{<a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a>}</span> <b>newport</b>
                                          
                                      </dt>
                                      <dd>the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> port to connect to or from.</dd>
                                  
                                      <dt>
                                          <span class="light fixedFont">{boolean}</span> <b>toend</b>
                                          
                                      </dt>
                                      <dd>If true, this modifies the link's "to" node and port; otherwise it modifies the "from" node and port.</dd>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{boolean}</span> true if successful.</dt>
            ...
            <tr id="updateAdornments">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Show an <a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a> for each end of the <a href="../symbols/Link.html" class="linkConstructor">Link</a> that the user may reconnect.<span class="nodetails" id="xmethupdateAdornments"><a class="morelink" onclick="hst('methupdateAdornments')">More...</a></span> <span class="details" id="methupdateAdornments">The Adornment may have a copy of <a href="../symbols/RelinkingTool.html#fromHandleArchetype" class="linkProperty">fromHandleArchetype</a> and/or <a href="../symbols/RelinkingTool.html#toHandleArchetype" class="linkProperty">toHandleArchetype</a>.</span><div class="details" id="dmethupdateAdornments"><p>This method may be overridden.</div>
                ...
                <dl class="inheritsList">
                <dt>Methods borrowed from class <a href="../symbols/LinkingBaseTool.html" class="linkConstructor">LinkingBaseTool</a>: </dt><dd><a href="../symbols/LinkingBaseTool.html#copyPortProperties" class="linkMethod">copyPortProperties</a>, <a href="../symbols/LinkingBaseTool.html#doMouseMove" class="linkMethod">doMouseMove</a>, <a href="../symbols/LinkingBaseTool.html#findTargetPort" class="linkMethod">findTargetPort</a>, <a href="../symbols/LinkingBaseTool.html#isInSameNode" class="linkMethod">isInSameNode</a>, <a href="../symbols/LinkingBaseTool.html#isLinked" class="linkMethod">isLinked</a>, <a href="../symbols/LinkingBaseTool.html#isValidCycle" class="linkMethod">isValidCycle</a>, <a href="../symbols/LinkingBaseTool.html#isValidFrom" class="linkMethod">isValidFrom</a>, <a href="../symbols/LinkingBaseTool.html#isValidLink" class="linkMethod">isValidLink</a>, <a href="../symbols/LinkingBaseTool.html#isValidTo" class="linkMethod">isValidTo</a>, <a href="../symbols/LinkingBaseTool.html#setNoTargetPortProperties" class="linkMethod">setNoTargetPortProperties</a></dd><dt>Methods borrowed from class <a href="../symbols/Tool.html" class="linkConstructor">Tool</a>: </dt><dd><a href="../symbols/Tool.html#cancelWaitAfter" class="linkMethod">cancelWaitAfter</a>, <a href="../symbols/Tool.html#canStartMultiTouch" class="linkMethod">canStartMultiTouch</a>, <a href="../symbols/Tool.html#doCancel" class="linkMethod">doCancel</a>, <a href="../symbols/Tool.html#doKeyDown" class="linkMethod">doKeyDown</a>, <a href="../symbols/Tool.html#doKeyUp" class="linkMethod">doKeyUp</a>, <a href="../symbols/Tool.html#doMouseDown" class="linkMethod">doMouseDown</a>, <a href="../symbols/Tool.html#doMouseWheel" class="linkMethod">doMouseWheel</a>, <a href="../symbols/Tool.html#doStart" class="linkMethod">doStart</a>, <a href="../symbols/Tool.html#doStop" class="linkMethod">doStop</a>, <a href="../symbols/Tool.html#doWaitAfter" class="linkMethod">doWaitAfter</a>, <a href="../symbols/Tool.html#findToolHandleAt" class="linkMethod">findToolHandleAt</a>, <a href="../symbols/Tool.html#isBeyondDragSize" class="linkMethod">isBeyondDragSize</a>, <a href="../symbols/Tool.html#standardMouseClick" class="linkMethod">standardMouseClick</a>, <a href="../symbols/Tool.html#standardMouseOver" class="linkMethod">standardMouseOver</a>, <a href="../symbols/Tool.html#standardMouseSelect" class="linkMethod">standardMouseSelect</a>, <a href="../symbols/Tool.html#standardMouseWheel" class="linkMethod">standardMouseWheel</a>, <a href="../symbols/Tool.html#standardPinchZoomMove" class="linkMethod">standardPinchZoomMove</a>, <a href="../symbols/Tool.html#standardPinchZoomStart" class="linkMethod">standardPinchZoomStart</a>, <a href="../symbols/Tool.html#standardWaitAfter" class="linkMethod">standardWaitAfter</a>, <a href="../symbols/Tool.html#startTransaction" class="linkMethod">startTransaction</a>, <a href="../symbols/Tool.html#stopTool" class="linkMethod">stopTool</a>, <a href="../symbols/Tool.html#stopTransaction" class="linkMethod">stopTransaction</a></dd>
                </dl>
