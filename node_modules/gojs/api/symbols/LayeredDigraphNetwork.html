...
<html>
    <head>
        ...
        <title>GoJS&reg; LayeredDigraphNetwork Class</title>
...
<div class="sidebar-nav">
  ...
  <div class="navbar navbar-default" role="navigation">
    ...
    <div id="header" class="fineprint">
      <b>GoJS</b>&reg; Diagramming Components<br/>version 1.8.25 for JavaScript/HTML<br/>by <a href="https://www.nwoods.com/">Northwoods Software&reg;</a>
    </div>
...
<!-- ============================== class summary ========================== -->
            <p class="classsummary">
                ...
                <span class="extends"> Extends
                    <a href="../symbols/LayoutNetwork.html" class="linkConstructor">LayoutNetwork</a>.</span>
                

                This class represents an abstract graph of <a href="../symbols/LayeredDigraphVertex.html" class="linkConstructor">LayeredDigraphVertex</a>es and <a href="../symbols/LayeredDigraphEdge.html" class="linkConstructor">LayeredDigraphEdge</a>sthat can be constructed based on the <a href="../symbols/Node.html" class="linkConstructor">Node</a>s and <a href="../symbols/Link.html" class="linkConstructor">Link</a>s of a <a href="../symbols/Diagram.html" class="linkConstructor">Diagram</a>so that the <a href="../symbols/LayeredDigraphLayout.html" class="linkConstructor">LayeredDigraphLayout</a> can operate independently of the diagram until itis time to commit any node positioning or link routing.<p>This class inherits from <a href="../symbols/LayoutNetwork.html" class="linkConstructor">LayoutNetwork</a>.
            </p>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class LayeredDigraphNetwork.">
                <thead>
                        <tr>
...
<!-- ============================== properties summary ===================== -->
                ...
                <dt>Properties borrowed from class <a href="../symbols/LayoutNetwork.html" class="linkConstructor">LayoutNetwork</a>: </dt><dd><a href="../symbols/LayoutNetwork.html#edges" class="linkProperty">edges</a>, <a href="../symbols/LayoutNetwork.html#layout" class="linkProperty">layout</a>, <a href="../symbols/LayoutNetwork.html#vertexes" class="linkProperty">vertexes</a></dd>
                </dl>
...
<!-- ============================== methods summary ======================== -->
                ...
                <dl class="inheritsList">
                <dt>Methods borrowed from class <a href="../symbols/LayoutNetwork.html" class="linkConstructor">LayoutNetwork</a>: </dt><dd><a href="../symbols/LayoutNetwork.html#addEdge" class="linkMethod">addEdge</a>, <a href="../symbols/LayoutNetwork.html#addLink" class="linkMethod">addLink</a>, <a href="../symbols/LayoutNetwork.html#addNode" class="linkMethod">addNode</a>, <a href="../symbols/LayoutNetwork.html#addParts" class="linkMethod">addParts</a>, <a href="../symbols/LayoutNetwork.html#addVertex" class="linkMethod">addVertex</a>, <a href="../symbols/LayoutNetwork.html#createEdge" class="linkMethod">createEdge</a>, <a href="../symbols/LayoutNetwork.html#createVertex" class="linkMethod">createVertex</a>, <a href="../symbols/LayoutNetwork.html#deleteArtificialVertexes" class="linkMethod">deleteArtificialVertexes</a>, <a href="../symbols/LayoutNetwork.html#deleteEdge" class="linkMethod">deleteEdge</a>, <a href="../symbols/LayoutNetwork.html#deleteLink" class="linkMethod">deleteLink</a>, <a href="../symbols/LayoutNetwork.html#deleteNode" class="linkMethod">deleteNode</a>, <a href="../symbols/LayoutNetwork.html#deleteSelfEdges" class="linkMethod">deleteSelfEdges</a>, <a href="../symbols/LayoutNetwork.html#deleteVertex" class="linkMethod">deleteVertex</a>, <a href="../symbols/LayoutNetwork.html#findAllParts" class="linkMethod">findAllParts</a>, <a href="../symbols/LayoutNetwork.html#findEdge" class="linkMethod">findEdge</a>, <a href="../symbols/LayoutNetwork.html#findVertex" class="linkMethod">findVertex</a>, <a href="../symbols/LayoutNetwork.html#linkVertexes" class="linkMethod">linkVertexes</a>, <a href="../symbols/LayoutNetwork.html#reverseEdge" class="linkMethod">reverseEdge</a>, <a href="../symbols/LayoutNetwork.html#splitIntoSubNetworks" class="linkMethod">splitIntoSubNetworks</a></dd>
                </dl>
...
<!-- ============================== footer ================================= -->
        <div id="footer" class="fineprint" style="clear:both">
            Copyright &copy; 1998-2018 by <a href="https://www.nwoods.com/">Northwoods Software Corporation.</a>
        </div>
    </body>
</html>
