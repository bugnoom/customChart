...
<html>
    <head>
        ...
        <title>GoJS&reg; Size Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class Size.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>The default constructor produces the Size(0,0).<span class="nodetails" id="xconSize"><a class="morelink" onclick="hst('conSize')">More...</a></span> <span class="details" id="conSize">This constructor may take either zero arguments or two arguments.</span>
                            ...
                            <dt class="heading">Parameters:</dt>
                                ...
                                <dt>
                                    ...
                                    <dd>The initial width (must be non-negative).</dd>
                            
                                <dt>
                                    <span class="light fixedFont">{number=}</span>  <b>h</b>
                                    
                                </dt>
                                    <dd>The initial height (must be non-negative).</dd>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class Size.">
                    <thead>
                        <tr>
              ...
              <tr id="height" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the height value of the Size.<span class="nodetails" id="xpropheight"><a class="morelink" onclick="hst('propheight')">More...</a></span> <span class="details" id="propheight">The value must not be negative.</span>
              ...
              <tr id="width" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the width value of the Size.<span class="nodetails" id="xpropwidth"><a class="morelink" onclick="hst('propwidth')">More...</a></span> <span class="details" id="propwidth">The value must not be negative.</span>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class Size.">
                    <thead>
                        <tr>
            ...
            <tr id="copy">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Create a copy of this Size, with the same values.
            ...
            <tr id="equals">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Indicates whether the given Size is equal to the current Size.<span class="nodetails" id="xmethequals"><a class="morelink" onclick="hst('methequals')">More...</a></span> <span class="details" id="methequals"></span>
                 
                                </p><div class="seealso">See also:
                  <ul class="seealsolist">
                                  
                                    <li><a href="../symbols/Size.html#equalTo" class="linkMethod">equalTo</a></li>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dd>The Size to compare to the current Size.</dd>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{boolean}</span> True if the Sizes have the same width and height,false otherwise.</dt>
            ...
            <tr id="equalTo">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Indicates whether the given size is equal to this Size.<span class="nodetails" id="xmethequalTo"><a class="morelink" onclick="hst('methequalTo')">More...</a></span> <span class="details" id="methequalTo"></span>
                 
                                </p><div class="seealso">See also:
                  <ul class="seealsolist">
                                  
                                    <li><a href="../symbols/Size.html#equals" class="linkMethod">equals</a></li>
            ...
            <tr id="isReal">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>True if this Size has Width and Height values that are real numbers and not infinity.
            ...
            <tr id=".parse">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This static function can be used to read in a <a href="../symbols/Size.html" class="linkConstructor">Size</a> from a string that was produced by <a href="../symbols/Size.html#.stringify" class="linkStatic">Size.stringify</a>.<span class="nodetails" id="xmethparse"><a class="morelink" onclick="hst('methparse')">More...</a></span> <span class="details" id="methparse"></span><div class="details" id="dmethparse"><p><code>go.Size.parse("1 2")</code> produces the Size <code>new go.Size(1, 2)</code>.</div>
            ...
            <tr id="set">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Modify this Size so that its Width and Height values are the same as the given Size.<span class="nodetails" id="xmethset"><a class="morelink" onclick="hst('methset')">More...</a></span> <span class="details" id="methset"></span>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{<a href="../symbols/Size.html" class="linkConstructor">Size</a>}</span> this.</dt>
            ...
            <tr id="setTo">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Modify this Size with new Width and Height values.<span class="nodetails" id="xmethsetTo"><a class="morelink" onclick="hst('methsetTo')">More...</a></span> <span class="details" id="methsetTo"></span>
            ...
            <tr id=".stringify">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This static function can be used to write out a <a href="../symbols/Size.html" class="linkConstructor">Size</a> as a string that can be read by <a href="../symbols/Size.html#.parse" class="linkStatic">Size.parse</a>.<span class="nodetails" id="xmethstringify"><a class="morelink" onclick="hst('methstringify')">More...</a></span> <span class="details" id="methstringify"></span><div class="details" id="dmethstringify"><p><code>go.Size.stringify(new go.Size(1, 2))</code> produces the string "1 2".</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{<a href="../symbols/Size.html" class="linkConstructor">Size</a>}</span> <b>val</b>
