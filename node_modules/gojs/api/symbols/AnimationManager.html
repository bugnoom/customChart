...
<html>
    <head>
        ...
        <title>GoJS&reg; AnimationManager Class</title>
      ...
      <span class="hideshowall">
        ...
        <span class="details"><button id="buttonHide">Show Summaries</button></span>
            ...
            <p class="classsummary">
                ...
                AnimationManager handles animations in a <a href="../symbols/Diagram.html" class="linkConstructor">Diagram</a>. Each Diagram has one, <a href="../symbols/Diagram.html#animationManager" class="linkProperty">Diagram.animationManager</a>.Layouts, Group expansion and Tree expansion automatically start animations.<p>Animation is enabled by default, setting the <a href="../symbols/AnimationManager.html#isEnabled" class="linkProperty">isEnabled</a> property to false will turn off animations for a Diagram.<p>When an animations begins it raises the "AnimationStarting" diagram event,upon completion it raises the "AnimationFinished" diagram event.<p>Animation will stop if a new transaction is started, if an undo or redo is called,if a layout is invalidated, or if a model is replaced.When an animation is stopped, the Diagram immediately finishes the animation and draws the final state.Animations can be stopped programatically with the method <a href="../symbols/AnimationManager.html#stopAnimation" class="linkMethod">AnimationManager.stopAnimation</a>.
            </p>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class AnimationManager.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>You do not normally need to create an instance of this classbecause one already exists as the <a href="../symbols/Diagram.html#animationManager" class="linkProperty">Diagram.animationManager</a>, which you can modify.
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class AnimationManager.">
                    <thead>
                        <tr>
              ...
              <tr id="duration" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the duration for animations, in milliseconds.<span class="nodetails" id="xpropduration"><a class="morelink" onclick="hst('propduration')">More...</a></span> <span class="details" id="propduration">The default value is 600 milliseconds.The value must be a number greater than or equal to 1.Setting this property does not raise any events.</span>
                
                    <div class="seealso">See also:
                        <ul class="seealsolist">
                            
                                <li><a href="../symbols/AnimationManager.html#isEnabled" class="linkProperty">isEnabled</a></li>
              ...
              <tr id="isAnimating" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property is true when the animation manger is currently animating.<span class="nodetails" id="xpropisAnimating"><a class="morelink" onclick="hst('propisAnimating')">More...</a></span> <span class="details" id="propisAnimating"></span><div class="details" id="dpropisAnimating"><p>This value cannot be set, but animation can be stopped by calling <a href="../symbols/AnimationManager.html#stopAnimation" class="linkMethod">stopAnimation</a>,and it can be prevented by setting <a href="../symbols/AnimationManager.html#isEnabled" class="linkProperty">isEnabled</a>.</div>
              ...
              <tr id="isEnabled" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets whether this AnimationManager operates.<span class="nodetails" id="xpropisEnabled"><a class="morelink" onclick="hst('propisEnabled')">More...</a></span> <span class="details" id="propisEnabled"></span><div class="details" id="dpropisEnabled"><p>The default value is true.Setting this to false does not stop an animation, it only stops future animations.To stop any ongoing animation, use <a href="../symbols/AnimationManager.html#stopAnimation" class="linkMethod">stopAnimation</a>.Setting this property does not raise any events.</div>
              ...
              <tr id="isInitial" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets whether an animation is performed on an initial layout.<span class="nodetails" id="xpropisInitial"><a class="morelink" onclick="hst('propisInitial')">More...</a></span> <span class="details" id="propisInitial"></span><div class="details" id="dpropisInitial"><p>The default value is true.Changing the value does not affect any ongoing animation.Setting this property does not raise any events.</div>
              ...
              <tr id="isTicking" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property is true when the animation manger is in the middle of an animation tick.<span class="nodetails" id="xpropisTicking"><a class="morelink" onclick="hst('propisTicking')">More...</a></span> <span class="details" id="propisTicking">Animation only operates on GraphObjects during ticks, but code outside of AnimationManager's control may execute between ticks.</span><div class="details" id="dpropisTicking"><p>isTicking can only be true when <a href="../symbols/AnimationManager.html#isAnimating" class="linkProperty">isAnimating</a> is also true.<p>This value cannot be set.</div>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class AnimationManager.">
                    <thead>
                        <tr>
            ...
            <tr id="stopAnimation">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Stops any running animation and updates the Diagram to its final state.<span class="nodetails" id="xmethstopAnimation"><a class="morelink" onclick="hst('methstopAnimation')">More...</a></span> <span class="details" id="methstopAnimation"></span><div class="details" id="dmethstopAnimation"><p>If an animation was about to begin, it is cancelled.</div>
