...
<html>
    <head>
        ...
        <title>GoJS&reg; LayoutEdge Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class LayoutEdge.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>This constructs an edge that does not know about any <a href="../symbols/Link.html" class="linkConstructor">Link</a>.
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class LayoutEdge.">
                    <thead>
                        <tr>
              ...
              <tr id="data" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>For virtualized layouts working on model data instead of a Link.
              ...
              <tr id="fromVertex" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the <a href="../symbols/LayoutVertex.html" class="linkConstructor">LayoutVertex</a> that this edge comes from.<span class="nodetails" id="xpropfromVertex"><a class="morelink" onclick="hst('propfromVertex')">More...</a></span> <span class="details" id="propfromVertex">Setting this property does not change any <a href="../symbols/LayoutVertex.html#destinationEdges" class="linkProperty">LayoutVertex.destinationEdges</a> collection.</span>
              ...
              <tr id="link" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the <a href="../symbols/Link.html" class="linkConstructor">Link</a> associated with this edge, if any.<span class="nodetails" id="xproplink"><a class="morelink" onclick="hst('proplink')">More...</a></span> <span class="details" id="proplink">The value may be null if this edge is a "dummy" edge,not represented by a real <a href="../symbols/Link.html" class="linkConstructor">Link</a> in the <a href="../symbols/Diagram.html" class="linkConstructor">Diagram</a>.</span>
              ...
              <tr id="network" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the <a href="../symbols/LayoutNetwork.html" class="linkConstructor">LayoutNetwork</a> that owns this edge.<span class="nodetails" id="xpropnetwork"><a class="morelink" onclick="hst('propnetwork')">More...</a></span> <span class="details" id="propnetwork">The default value is null.It is set automatically for you in <a href="../symbols/LayoutNetwork.html#addEdge" class="linkMethod">LayoutNetwork.addEdge</a>.</span>
              ...
              <tr id="toVertex" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the <a href="../symbols/LayoutVertex.html" class="linkConstructor">LayoutVertex</a> that this edge goes to.<span class="nodetails" id="xproptoVertex"><a class="morelink" onclick="hst('proptoVertex')">More...</a></span> <span class="details" id="proptoVertex">Setting this property does not change any <a href="../symbols/LayoutVertex.html#sourceEdges" class="linkProperty">LayoutVertex.sourceEdges</a> collection.</span>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class LayoutEdge.">
                    <thead>
                        <tr>
            ...
            <tr id="commit">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Commits the route of this edge to the corresponding <a href="../symbols/Link.html" class="linkConstructor">Link</a>, if any.<span class="nodetails" id="xmethcommit"><a class="morelink" onclick="hst('methcommit')">More...</a></span> <span class="details" id="methcommit">By default this does nothing.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</span>
            ...
            <tr id="getOtherVertex">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Returns the edge's vertex at the other of this edge from the given vertex.<span class="nodetails" id="xmethgetOtherVertex"><a class="morelink" onclick="hst('methgetOtherVertex')">More...</a></span> <span class="details" id="methgetOtherVertex"></span>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{V}</span> <b>v</b>
