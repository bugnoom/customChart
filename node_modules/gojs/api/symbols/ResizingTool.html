...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <tr id="computeReshape">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Decide whether to allow arbitrary reshaping or whether to keep the same aspect ratio of the object being resized.<span class="nodetails" id="xmethcomputeReshape"><a class="morelink" onclick="hst('methcomputeReshape')">More...</a></span> <span class="details" id="methcomputeReshape">If the <a href="../symbols/ResizingTool.html#adornedObject" class="linkProperty">adornedObject</a> is a <a href="../symbols/Shape.html" class="linkConstructor">Shape</a>,then if the <a href="../symbols/GraphObject.html#stretch" class="linkProperty">GraphObject.stretch</a> is <a href="../symbols/GraphObject.html#Uniform" class="linkConstant">GraphObject.Uniform</a> or <a href="../symbols/GraphObject.html#UniformToFill" class="linkConstant">GraphObject.UniformToFill</a>,this method will return false to restrict reshaping to maintain the object's current ratio of height to width.Also, if the user is holding down the Shift key, this method will return false.</span><div class="details" id="dmethcomputeReshape"><p>This is called on each mouse-move and on mouse-up; the result is passed to the call to <a href="../symbols/ResizingTool.html#resize" class="linkMethod">resize</a>.This permits the user to change the behavior dynamically during resizing.<p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.For example, to always keep the object's original aspect ratio, override this method to return false.When calling <a href="../symbols/GraphObject.html#.make" class="linkStatic">GraphObject.make</a> to initialize a <a href="../symbols/Diagram.html" class="linkConstructor">Diagram</a>:<pre class="javascript">$(go.Diagram, . . .,  {    "resizingTool.computeReshape": function() { return false; },    . . . })</pre>Or when overriding the method dynamically:<pre class="javascript">  myDiagram.toolManager.resizingTool.computeReshape = function() { return false; };</pre>Your override might want to look at the <code>this.adornedObject.part.data</code> properties to decide whether to allow reshaping.</div>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{boolean}</span> true to allow any aspect ratio; false to preserve the <a href="../symbols/ResizingTool.html#adornedObject" class="linkProperty">adornedObject</a>'s height/width ratio</dt>
                ...
                <td class="description">
                                ...
                                <!--newp--><p><p>Given a <a href="../symbols/Spot.html" class="linkConstructor">Spot</a> in the original bounds of the object being resized and a new <a href="../symbols/Point.html" class="linkConstructor">Point</a>,compute the new <a href="../symbols/Rect.html" class="linkConstructor">Rect</a>.<span class="nodetails" id="xmethcomputeResize"><a class="morelink" onclick="hst('methcomputeResize')">More...</a></span> <span class="details" id="methcomputeResize"></span><div class="details" id="dmethcomputeResize"><p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{<a href="../symbols/Rect.html" class="linkConstructor">Rect</a>}</span> a Rectangle in the <a href="../symbols/ResizingTool.html#adornedObject" class="linkProperty">adornedObject</a>'s local coordinates, not in document coordinates</dt>
            ...
            <tr id="doActivate">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Find the <a href="../symbols/ResizingTool.html#handle" class="linkProperty">handle</a>, remember the object's original bounds,save the results of calling <a href="../symbols/ResizingTool.html#computeMinSize" class="linkMethod">computeMinSize</a>, <a href="../symbols/ResizingTool.html#computeMaxSize" class="linkMethod">computeMaxSize</a>, and <a href="../symbols/ResizingTool.html#computeCellSize" class="linkMethod">computeCellSize</a>,capture the mouse, and start a transaction.<span class="nodetails" id="xmethdoActivate"><a class="morelink" onclick="hst('methdoActivate')">More...</a></span> <span class="details" id="methdoActivate"></span><div class="details" id="dmethdoActivate"><p>If the call to <a href="../symbols/Tool.html#findToolHandleAt" class="linkMethod">Tool.findToolHandleAt</a> finds no "Resizing" tool handle, this method returns without activating this tool.</div>
            ...
            <tr id="doCancel">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Restore the original size of the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a>.
            ...
            <tr id="doMouseMove">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Call <a href="../symbols/ResizingTool.html#resize" class="linkMethod">resize</a> with a new size determined by the current mouse point.<span class="nodetails" id="xmethdoMouseMove"><a class="morelink" onclick="hst('methdoMouseMove')">More...</a></span> <span class="details" id="methdoMouseMove">This determines the new bounds by calling <a href="../symbols/ResizingTool.html#computeResize" class="linkMethod">computeResize</a>.</span><div class="details" id="dmethdoMouseMove"><p>When this calls <a href="../symbols/ResizingTool.html#computeResize" class="linkMethod">computeResize</a> it passes as the reshape argument the result of calling <a href="../symbols/ResizingTool.html#computeReshape" class="linkMethod">computeReshape</a>.The min, max, and cell arguments will be the saved results of <a href="../symbols/ResizingTool.html#doActivate" class="linkMethod">doActivate</a>'s calls to <a href="../symbols/ResizingTool.html#computeMinSize" class="linkMethod">computeMinSize</a>, <a href="../symbols/ResizingTool.html#computeMaxSize" class="linkMethod">computeMaxSize</a>, and <a href="../symbols/ResizingTool.html#computeCellSize" class="linkMethod">computeCellSize</a>.</div>
