...
<html>
    <head>
        ...
        <title>GoJS&reg; Adornment Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class Adornment.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>The constructor builds an empty Adornment.<span class="nodetails" id="xconAdornment"><a class="morelink" onclick="hst('conAdornment')">More...</a></span> <span class="details" id="conAdornment">The optional argument specifies the <a href="../symbols/Panel.html#type" class="linkProperty">Panel.type</a>.Add whatever GraphObjects you need so that it can show handles, ornamentation, buttons or whatever you need to show for a Part.</span>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class Adornment.">
                    <thead>
                        <tr>
              ...
              <tr id="adornedObject" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> that is adorned.<span class="nodetails" id="xpropadornedObject"><a class="morelink" onclick="hst('propadornedObject')">More...</a></span> <span class="details" id="propadornedObject">Setting this property updates the adorned object's Part by calling <a href="../symbols/Part.html#addAdornment" class="linkMethod">Part.addAdornment</a>.This may be null if the Adornment does not adorn a particular object.</span>
              ...
              <tr id="adornedPart" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property returns the <a href="../symbols/Part.html" class="linkConstructor">Part</a> that contains the adorned object.<span class="nodetails" id="xpropadornedPart"><a class="morelink" onclick="hst('propadornedPart')">More...</a></span> <span class="details" id="propadornedPart">This will be null if the <a href="../symbols/Adornment.html#adornedObject" class="linkProperty">adornedObject</a> is null.</span>
              ...
              <tr id="placeholder" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property returns a <a href="../symbols/Placeholder.html" class="linkConstructor">Placeholder</a> that this Adornment may contain in its visual tree.<span class="nodetails" id="xpropplaceholder"><a class="morelink" onclick="hst('propplaceholder')">More...</a></span> <span class="details" id="propplaceholder">This may be null if there is no such placeholder object.</span>
