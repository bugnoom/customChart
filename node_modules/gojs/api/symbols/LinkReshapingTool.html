...
<html>
    <head>
        ...
        <title>GoJS&reg; LinkReshapingTool Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class LinkReshapingTool.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>You do not normally need to create an instance of this toolbecause one already exists as the <a href="../symbols/ToolManager.html#linkReshapingTool" class="linkProperty">ToolManager.linkReshapingTool</a>, which you can modify.<span class="nodetails" id="xconLinkReshapingTool"><a class="morelink" onclick="hst('conLinkReshapingTool')">More...</a></span> <span class="details" id="conLinkReshapingTool"></span><div class="details" id="dconLinkReshapingTool"><p>The <a href="../symbols/Tool.html#name" class="linkProperty">Tool.name</a> of this tool is "LinkReshaping".</div>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class LinkReshapingTool.">
                    <thead>
                        <tr>
              ...
              <tr id="adornedLink" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property returns the <a href="../symbols/Link.html" class="linkConstructor">Link</a> that is being routed manually.
              ...
              <tr id="handle" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property returns the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> that is the tool handle being dragged by the user.<span class="nodetails" id="xprophandle"><a class="morelink" onclick="hst('prophandle')">More...</a></span> <span class="details" id="prophandle">This will be contained by an <a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a> whose category is "LinkReshaping".Its <a href="../symbols/Adornment.html#adornedPart" class="linkProperty">Adornment.adornedPart</a> is the same as the <a href="../symbols/LinkReshapingTool.html#adornedLink" class="linkProperty">adornedLink</a>.</span>
              ...
              <tr id="midHandleArchetype" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets a small GraphObject that is copied as a resegment handle at each mid-point in the selected Link's route.<span class="nodetails" id="xpropmidHandleArchetype"><a class="morelink" onclick="hst('propmidHandleArchetype')">More...</a></span> <span class="details" id="propmidHandleArchetype">By default this is a <a href="../symbols/Shape.html" class="linkConstructor">Shape</a> that is a small blue diamond.Setting this property does not raise any events.</span><div class="details" id="dpropmidHandleArchetype"><p>Here is an example of changing the default handle to be larger cyan triangles:<pre class="javascript">  myDiagram.toolManager.linkReshapingTool.midHandleArchetype =    $(go.Shape, "Triangle", { width: 10, height: 10, fill: "cyan" });</pre></div>
                
                    <div class="seealso">See also:
                        <ul class="seealsolist">
                            
                                <li><a href="../symbols/LinkReshapingTool.html#handleArchetype" class="linkProperty">handleArchetype</a></li>
              ...
              <tr id="originalPoint" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property returns the <a href="../symbols/Point.html" class="linkConstructor">Point</a> that was the original location of the handle that is being dragged to reshape the Link.
                
                </div>
                            </td>
                        </tr>
                    
              <tr id="originalPoints" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property returns the <a href="../symbols/List.html" class="linkConstructor">List</a> of <a href="../symbols/Point.html" class="linkConstructor">Point</a>s that was the original route of the Link that is being reshaped.<span class="nodetails" id="xproporiginalPoints"><a class="morelink" onclick="hst('proporiginalPoints')">More...</a></span> <span class="details" id="proporiginalPoints">This List should not be modified; its value is indeterminate until a reshaping has been activated.</span>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class LinkReshapingTool.">
                    <thead>
                        <tr>
            ...
            <tr id="canStart">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This tool may run when there is a mouse-down event on a reshape handle.<span class="nodetails" id="xmethcanStart"><a class="morelink" onclick="hst('methcanStart')">More...</a></span> <span class="details" id="methcanStart"></span><div class="details" id="dmethcanStart"><p>This method may be overridden.</div>
            ...
            <tr id="computeReshape">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This is called by <a href="../symbols/LinkReshapingTool.html#doMouseMove" class="linkMethod">doMouseMove</a> and <a href="../symbols/LinkReshapingTool.html#doMouseUp" class="linkMethod">doMouseUp</a> to limit the input pointbefore calling <a href="../symbols/LinkReshapingTool.html#reshape" class="linkMethod">reshape</a>.<span class="nodetails" id="xmethcomputeReshape"><a class="morelink" onclick="hst('methcomputeReshape')">More...</a></span> <span class="details" id="methcomputeReshape"></span><div class="details" id="dmethcomputeReshape"><p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dd>the point where the handle is being dragged.</dd>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{<a href="../symbols/Point.html" class="linkConstructor">Point</a>}</span> Either the same Point p or one constrained by the reshape behavior to be movedonly vertically or only horizontally.</dt>
            ...
            <tr id="doActivate">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Start reshaping, if <a href="../symbols/Tool.html#findToolHandleAt" class="linkMethod">findToolHandleAt</a> finds a reshape handle at the mouse down point.<span class="nodetails" id="xmethdoActivate"><a class="morelink" onclick="hst('methdoActivate')">More...</a></span> <span class="details" id="methdoActivate"></span><div class="details" id="dmethdoActivate"><p>If successful this sets <a href="../symbols/LinkReshapingTool.html#handle" class="linkProperty">handle</a> to be the reshape handle that it findsand <a href="../symbols/LinkReshapingTool.html#adornedLink" class="linkProperty">adornedLink</a> to be the <a href="../symbols/Link.html" class="linkConstructor">Link</a> being routed.It also remembers the original link route (a list of Points) in case this tool is cancelled.And it starts a transaction.</div>
            ...
            <tr id="doCancel">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Restore the link route to be the original points and stop this tool.
            ...
            <tr id="doDeactivate">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This stops the current reshaping operation with the link route shaped the way it is.
            ...
            <tr id="doMouseMove">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Call <a href="../symbols/LinkReshapingTool.html#reshape" class="linkMethod">reshape</a> with a new point determined by the mouseto change the route of the <a href="../symbols/LinkReshapingTool.html#adornedLink" class="linkProperty">adornedLink</a>.
            ...
            <tr id="doMouseUp">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Reshape the route with a point based on the most recent mouse point by calling <a href="../symbols/LinkReshapingTool.html#reshape" class="linkMethod">reshape</a>,and then raise a "LinkReshaped" <a href="../symbols/DiagramEvent.html" class="linkConstructor">DiagramEvent</a> before stopping this tool.
            ...
            <tr id="getReshapingBehavior">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Get the permitted reshaping behavior for a particular reshape handle.<span class="nodetails" id="xmethgetReshapingBehavior"><a class="morelink" onclick="hst('methgetReshapingBehavior')">More...</a></span> <span class="details" id="methgetReshapingBehavior"></span>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dd>a reshape handle in the "LinkReshaping" Adornment.</dd>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{EnumValue}</span> one of LinkReshapingTool.All, .Vertical, .Horizontal, or .None</dt>
            ...
            <tr id="reshape">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Change the route of the <a href="../symbols/LinkReshapingTool.html#adornedLink" class="linkProperty">adornedLink</a> by moving the point corresponding to the current<a href="../symbols/LinkReshapingTool.html#handle" class="linkProperty">handle</a> to be at the given <a href="../symbols/Point.html" class="linkConstructor">Point</a>.<span class="nodetails" id="xmethreshape"><a class="morelink" onclick="hst('methreshape')">More...</a></span> <span class="details" id="methreshape">This is called by <a href="../symbols/LinkReshapingTool.html#doMouseMove" class="linkMethod">doMouseMove</a> and <a href="../symbols/LinkReshapingTool.html#doMouseUp" class="linkMethod">doMouseUp</a> with the result of calling<a href="../symbols/LinkReshapingTool.html#computeReshape" class="linkMethod">computeReshape</a> to constrain the input point.</span><div class="details" id="dmethreshape"><p>This method respects the orthogonality of the link, if necessary limiting movement along only one axis.To maintain orthogonality it may need to modify more than one point in the route.<p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dd>the value of the call to <a href="../symbols/LinkReshapingTool.html#computeReshape" class="linkMethod">computeReshape</a>.</dd>
            ...
            <tr id="setReshapingBehavior">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Set the permitted reshaping behavior for a particular reshape handle.<span class="nodetails" id="xmethsetReshapingBehavior"><a class="morelink" onclick="hst('methsetReshapingBehavior')">More...</a></span> <span class="details" id="methsetReshapingBehavior"></span>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{EnumValue}</span> <b>behavior</b>
                                          
                                      </dt>
                                      <dd>one of LinkReshapingTool.All, .Vertical, .Horizontal, or .None</dd>
            ...
            <tr id="updateAdornments">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Show an <a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a> with reshape handles at each of the interesting points of the link's route,if the link is selected and visible and if <a href="../symbols/Part.html#canReshape" class="linkMethod">Part.canReshape</a> is true.<span class="nodetails" id="xmethupdateAdornments"><a class="morelink" onclick="hst('methupdateAdornments')">More...</a></span> <span class="details" id="methupdateAdornments"></span><div class="details" id="dmethupdateAdornments"><p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
...
<!-- ============================== fields summary ===================== -->
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Allow dragging in any direction.
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Allow only horizontal (left-and-right) dragging.
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Allow only vertical (up-and-down) dragging.
