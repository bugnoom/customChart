...
<html>
    <head>
        ...
        <title>GoJS&reg; ClickSelectingTool Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class ClickSelectingTool.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>You do not normally need to create an instance of this toolbecause one already exists as the <a href="../symbols/ToolManager.html#clickSelectingTool" class="linkProperty">ToolManager.clickSelectingTool</a>.<span class="nodetails" id="xconClickSelectingTool"><a class="morelink" onclick="hst('conClickSelectingTool')">More...</a></span> <span class="details" id="conClickSelectingTool"></span><div class="details" id="dconClickSelectingTool"><p>The <a href="../symbols/Tool.html#name" class="linkProperty">Tool.name</a> of this tool is "ClickSelecting".</div>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class ClickSelectingTool.">
                    <thead>
                        <tr>
            ...
            <tr id="doMouseUp">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Upon a click, this calls <a href="../symbols/Tool.html#standardMouseSelect" class="linkMethod">Tool.standardMouseSelect</a> to change the <a href="../symbols/Diagram.html#selection" class="linkProperty">Diagram.selection</a> collection,then calls <a href="../symbols/Tool.html#standardMouseClick" class="linkMethod">Tool.standardMouseClick</a> to perform the normal click behaviors,and then stops this tool.
