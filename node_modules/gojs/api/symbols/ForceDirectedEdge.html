...
<html>
    <head>
        ...
        <title>GoJS&reg; ForceDirectedEdge Class</title>
      ...
      <span class="hideshowall">
        ...
        <span class="details"><button id="buttonHide">Show Summaries</button></span>
            ...
            <p class="classsummary">
                ...
                This holds <a href="../symbols/ForceDirectedLayout.html" class="linkConstructor">ForceDirectedLayout</a>-specific information about <a href="../symbols/Link.html" class="linkConstructor">Link</a>s.<p>This class inherits from <a href="../symbols/LayoutEdge.html" class="linkConstructor">LayoutEdge</a>.
            </p>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class ForceDirectedEdge.">
                <thead>
                        <tr>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class ForceDirectedEdge.">
                    <thead>
                        <tr>
              ...
              <tr id="length" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the length of this edge.<span class="nodetails" id="xproplength"><a class="morelink" onclick="hst('proplength')">More...</a></span> <span class="details" id="proplength">The default value is NaN.</span>
              ...
              <tr id="stiffness" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets this edge's stiffness or resistance to compression or stretching.<span class="nodetails" id="xpropstiffness"><a class="morelink" onclick="hst('propstiffness')">More...</a></span> <span class="details" id="propstiffness">The default value is NaN.</span>
