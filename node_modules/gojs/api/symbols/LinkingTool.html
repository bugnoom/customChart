...
<html>
    <head>
        ...
        <title>GoJS&reg; LinkingTool Class</title>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                ...
                <td class="description">
                                ...
                                <!--newp--><p><p>Return the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> at the mouse-down point,if it is part of a node and if it is valid to link with it.<span class="nodetails" id="xmethfindLinkablePort"><a class="morelink" onclick="hst('methfindLinkablePort')">More...</a></span> <span class="details" id="methfindLinkablePort"></span><div class="details" id="dmethfindLinkablePort"><p>This method may be overridden, but we recommend that you call this base method.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{<a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a>}</span> If the <a href="../symbols/LinkingTool.html#direction" class="linkProperty">direction</a> is <a href="../symbols/LinkingTool.html#Either" class="linkConstant">Either</a> or <a href="../symbols/LinkingTool.html#ForwardsOnly" class="linkConstant">ForwardsOnly</a>,this checks the element and its parent <a href="../symbols/Node.html" class="linkConstructor">Node</a> by calling <a href="../symbols/LinkingBaseTool.html#isValidFrom" class="linkMethod">LinkingBaseTool.isValidFrom</a>.If the <a href="../symbols/LinkingTool.html#direction" class="linkProperty">direction</a> is <a href="../symbols/LinkingTool.html#Either" class="linkConstant">Either</a> or <a href="../symbols/LinkingTool.html#BackwardsOnly" class="linkConstant">BackwardsOnly</a>,this checks the element and its parent <a href="../symbols/Node.html" class="linkConstructor">Node</a> by calling <a href="../symbols/LinkingBaseTool.html#isValidTo" class="linkMethod">LinkingBaseTool.isValidTo</a>.In either case finding a matching port will return that port and set <a href="../symbols/LinkingBaseTool.html#isForwards" class="linkProperty">LinkingBaseTool.isForwards</a> appropriately.Otherwise this will return null.</dt>
            ...
            <tr id="insertLink">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Make a copy of the <a href="../symbols/LinkingTool.html#archetypeLinkData" class="linkProperty">archetypeLinkData</a>, set its node and port properties, and add it to the <a href="../symbols/GraphLinksModel.html" class="linkConstructor">GraphLinksModel</a>.<span class="nodetails" id="xmethinsertLink"><a class="morelink" onclick="hst('methinsertLink')">More...</a></span> <span class="details" id="methinsertLink">If the model is a <a href="../symbols/TreeModel.html" class="linkConstructor">TreeModel</a>, set the parent key of the child's node data object.</span><div class="details" id="dmethinsertLink"><p>For GraphLinksModels, if <a href="../symbols/LinkingTool.html#archetypeLabelNodeData" class="linkProperty">archetypeLabelNodeData</a> is non-null, this method also adds that node data as an initial label nodefor the new link data.<p>For TreeModels, if <a href="../symbols/Diagram.html#isTreePathToChildren" class="linkProperty">Diagram.isTreePathToChildren</a> is false, the roles of the <i>fromnode</i> and <i>tonode</i> arguments are exchanged.<p>This method may be overridden, but we recommend that you call this base method.Usually though it is easiest to just set <a href="../symbols/LinkingTool.html#archetypeLinkData" class="linkProperty">archetypeLinkData</a> to control what kind of link is createdPlease read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                 
                                </p><div class="seealso">See also:
                  <ul class="seealsolist">
                                  
                                    <li><a href="../symbols/LinkingTool.html#doNoLink" class="linkMethod">doNoLink</a></li>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{<a href="../symbols/Link.html" class="linkConstructor">Link</a>}</span> the newly created Link, or null if it failed.</dt>
...
<!-- ============================== fields summary ===================== -->
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This value for <a href="../symbols/LinkingTool.html#direction" class="linkProperty">LinkingTool.direction</a> indicates that users may draw new links backwards only(i.e.<span class="nodetails" id="xfldBackwardsOnly"><a class="morelink" onclick="hst('fldBackwardsOnly')">More...</a></span> <span class="details" id="fldBackwardsOnly"> from "to" node to "from" node).</span>
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This value for <a href="../symbols/LinkingTool.html#direction" class="linkProperty">LinkingTool.direction</a> indicates that users may draw new links in either direction.
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This value for <a href="../symbols/LinkingTool.html#direction" class="linkProperty">LinkingTool.direction</a> indicates that users may draw new links forwards only(i.e.<span class="nodetails" id="xfldForwardsOnly"><a class="morelink" onclick="hst('fldForwardsOnly')">More...</a></span> <span class="details" id="fldForwardsOnly"> from "from" node to "to" node).</span>
