...
<html>
    <head>
        ...
        <title>GoJS&reg; PathFigure Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class PathFigure.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>Constructs an empty figure.<span class="nodetails" id="xconPathFigure"><a class="morelink" onclick="hst('conPathFigure')">More...</a></span> <span class="details" id="conPathFigure">The optional arguments specify the starting point of the figure.You'll want to add a new instance of a PathFigure to the<a href="../symbols/Geometry.html#figures" class="linkProperty">Geometry.figures</a> list of a <a href="../symbols/Geometry.html" class="linkConstructor">Geometry</a>.</span>
                            ...
                            <dt class="heading">Parameters:</dt>
                                ...
                                <dt>
                                    ...
                                    <dd>optional: the X coordinate of the start point (default is zero).</dd>
                            
                                <dt>
                                    <span class="light fixedFont">{number=}</span>  <b>sy</b>
                                    
                                </dt>
                                    <dd>optional: the Y coordinate of the start point (default is zero).</dd>
                            
                                <dt>
                                    <span class="light fixedFont">{boolean=}</span>  <b>filled</b>
                                    
                                </dt>
                                    <dd>optional: whether the figure is filled (default is true).</dd>
                            
                                <dt>
                                    <span class="light fixedFont">{boolean=}</span>  <b>shadowed</b>
                                    
                                </dt>
                                    <dd>optional: whether the figure may be drawn with a shadow (default is true).</dd>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class PathFigure.">
                    <thead>
                        <tr>
              ...
              <tr id="isFilled" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets whether this PathFigure is drawn filled.<span class="nodetails" id="xpropisFilled"><a class="morelink" onclick="hst('propisFilled')">More...</a></span> <span class="details" id="propisFilled">The default value is true.</span>
              ...
              <tr id="isShadowed" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets whether this PathFigure will render a shadow if one is defined.<span class="nodetails" id="xpropisShadowed"><a class="morelink" onclick="hst('propisShadowed')">More...</a></span> <span class="details" id="propisShadowed">This is used for turning off shadows on specific subpaths.The default value is true.</span>
              ...
              <tr id="segments" >
                ...
                <td class="name">
                  ...
                  <div class="attributes">
                    <span class="light">{List.<PathSegment>}</span>
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the <a href="../symbols/List.html" class="linkConstructor">List</a> of <a href="../symbols/PathSegment.html" class="linkConstructor">PathSegment</a>s that define this PathFigure.
              ...
              <tr id="startX" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the starting point X coordinate of the PathFigure.<span class="nodetails" id="xpropstartX"><a class="morelink" onclick="hst('propstartX')">More...</a></span> <span class="details" id="propstartX">The default value is zero.</span>
              ...
              <tr id="startY" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the starting point Y coordinate of the PathFigure.<span class="nodetails" id="xpropstartY"><a class="morelink" onclick="hst('propstartY')">More...</a></span> <span class="details" id="propstartY">The default value is zero.</span>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class PathFigure.">
                    <thead>
                        <tr>
            ...
            <tr id="add">
                <td class="name">
                  ...
                  <div class="attributes">
                    <span class="light">{<a href="../symbols/PathFigure.html" class="linkConstructor">PathFigure</a>}</span>
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Add a <a href="../symbols/PathSegment.html" class="linkConstructor">PathSegment</a> to the <a href="../symbols/PathFigure.html#segments" class="linkProperty">segments</a> list.<span class="nodetails" id="xmethadd"><a class="morelink" onclick="hst('methadd')">More...</a></span> <span class="details" id="methadd"></span>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{<a href="../symbols/PathSegment.html" class="linkConstructor">PathSegment</a>}</span> <b>segment</b>
                                          
                                      </dt>
                                      <dd>a newly allocated unshared PathSegment that will become owned by this PathFigure</dd>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{<a href="../symbols/PathFigure.html" class="linkConstructor">PathFigure</a>}</span> </dt>
            ...
            <tr id="copy">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Create a copy of this PathFigure, with the same values and segments.
