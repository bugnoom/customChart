...
<html>
    <head>
        ...
        <title>GoJS&reg; Iterable Class</title>
      ...
      <span class="hideshowall">
        ...
        <span class="details"><button id="buttonHide">Show Summaries</button></span>
            ...
            <p class="classsummary">
                ...
                This interface is implemented by the <a href="../symbols/List.html" class="linkConstructor">List</a>, <a href="../symbols/Set.html" class="linkConstructor">Set</a>, and <a href="../symbols/Map.html" class="linkConstructor">Map</a>classes; it provides the <a href="../symbols/Iterable.html#iterator" class="linkProperty">iterator</a> read-only property that returns an <a href="../symbols/Iterator.html" class="linkConstructor">Iterator</a>.<p>Typical usage is:<pre>var it = anIterableCollection.iterator;while (it.next()) {  var item = it.value;}</pre>
            </p>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class Iterable.">
                <thead>
                        <tr>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class Iterable.">
                    <thead>
                        <tr>
              ...
              <tr id="iterator" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets an <a href="../symbols/Iterator.html" class="linkConstructor">Iterator</a> that can iterate over the items in the collection.<span class="nodetails" id="xpropiterator"><a class="morelink" onclick="hst('propiterator')">More...</a></span> <span class="details" id="propiterator"></span><div class="details" id="dpropiterator"><p>Typical usage is:<pre> var it = anIterableCollection.iterator; while (it.next()) {   var item = it.value; }</pre></div>
