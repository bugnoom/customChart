...
<html>
    <head>
        ...
        <title>GoJS&reg; TreeEdge Class</title>
      ...
      <span class="hideshowall">
        ...
        <span class="details"><button id="buttonHide">Show Summaries</button></span>
            ...
            <p class="classsummary">
                ...
                This holds <a href="../symbols/TreeLayout.html" class="linkConstructor">TreeLayout</a>-specific information about <a href="../symbols/Link.html" class="linkConstructor">Link</a>s.<p>This class inherits from <a href="../symbols/LayoutEdge.html" class="linkConstructor">LayoutEdge</a>.
            </p>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class TreeEdge.">
                <thead>
                        <tr>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class TreeEdge.">
                    <thead>
                        <tr>
              ...
              <tr id="relativePoint" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets a Point, relative to the parent node,that may be useful in routing this link.
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class TreeEdge.">
                    <thead>
                        <tr>
            ...
            <tr id="commit">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Commits the position of the Link and routes it.
                ...
                <dl class="inheritsList">
                <dt>Methods borrowed from class <a href="../symbols/LayoutEdge.html" class="linkConstructor">LayoutEdge</a>: </dt><dd><a href="../symbols/LayoutEdge.html#getOtherVertex" class="linkMethod">getOtherVertex</a></dd>
                </dl>
