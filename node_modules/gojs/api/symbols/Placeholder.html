...
<html>
    <head>
        ...
        <title>GoJS&reg; Placeholder Class</title>
      ...
      <span class="hideshowall">
        ...
        <span class="details"><button id="buttonHide">Show Summaries</button></span>
            ...
            <p class="classsummary">
                ...
                If a Placeholder is in the visual tree of a <a href="../symbols/Group.html" class="linkConstructor">Group</a>, it represents the area of all of the member <a href="../symbols/Part.html" class="linkConstructor">Part</a>s of that Group.If a Placeholder is in the visual tree of an <a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a>, it represents the area of the <a href="../symbols/Adornment.html#adornedObject" class="linkProperty">Adornment.adornedObject</a>.It can only be used in the visual tree of a Group node or an Adornment.There can be at most one Placeholder in a Group or an Adornment.<p>See the documentation for <a href="../symbols/Group.html" class="linkConstructor">Group</a> and <a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a> for descriptions of the Placeholder roles in each.
            </p>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class Placeholder.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>This normally does not need any initialization,except for maybe setting <a href="../symbols/Placeholder.html#padding" class="linkProperty">padding</a>.
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class Placeholder.">
                    <thead>
                        <tr>
              ...
              <tr id="padding" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the padding around the members of the <a href="../symbols/Group.html" class="linkConstructor">Group</a> or around the <a href="../symbols/Adornment.html#adornedObject" class="linkProperty">Adornment.adornedObject</a> <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a>.<span class="nodetails" id="xproppadding"><a class="morelink" onclick="hst('proppadding')">More...</a></span> <span class="details" id="proppadding">The initial value is a <a href="../symbols/Margin.html" class="linkConstructor">Margin</a> of zero on all sides.</span>
