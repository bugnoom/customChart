...
<html>
    <head>
        ...
        <title>GoJS&reg; LayeredDigraphVertex Class</title>
      ...
      <span class="hideshowall">
        ...
        <span class="details"><button id="buttonHide">Show Summaries</button></span>
            ...
            <p class="classsummary">
                ...
                This holds <a href="../symbols/LayeredDigraphLayout.html" class="linkConstructor">LayeredDigraphLayout</a>-specific information about <a href="../symbols/Node.html" class="linkConstructor">Node</a>s.<p>This class inherits from <a href="../symbols/LayoutVertex.html" class="linkConstructor">LayoutVertex</a>.
            </p>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class LayeredDigraphVertex.">
                <thead>
                        <tr>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class LayeredDigraphVertex.">
                    <thead>
                        <tr>
              ...
              <tr id="column" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>The column to which the node is assigned.<span class="nodetails" id="xpropcolumn"><a class="morelink" onclick="hst('propcolumn')">More...</a></span> <span class="details" id="propcolumn">The default value is -1.</span>
              ...
              <tr id="component" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>The connected component to which the node is assigned.<span class="nodetails" id="xpropcomponent"><a class="morelink" onclick="hst('propcomponent')">More...</a></span> <span class="details" id="propcomponent">The default value is NaN.</span>
              ...
              <tr id="index" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>The index to which the node is assigned.<span class="nodetails" id="xpropindex"><a class="morelink" onclick="hst('propindex')">More...</a></span> <span class="details" id="propindex">The default value is -1.</span>
              ...
              <tr id="layer" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>The layer to which the node is assigned.<span class="nodetails" id="xproplayer"><a class="morelink" onclick="hst('proplayer')">More...</a></span> <span class="details" id="proplayer">The default value is -1.</span>
              ...
              <tr id="near" >
                ...
                <td class="name">
                  ...
                  <div class="attributes">
                    <span class="light">{<a href="../symbols/LayeredDigraphVertex.html" class="linkConstructor">LayeredDigraphVertex</a>}</span>
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Another LayeredDigraphVertex in the same layer that this node should be near.<span class="nodetails" id="xpropnear"><a class="morelink" onclick="hst('propnear')">More...</a></span> <span class="details" id="propnear">The default value is null.</span>
