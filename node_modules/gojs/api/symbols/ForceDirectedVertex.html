...
<html>
    <head>
        ...
        <title>GoJS&reg; ForceDirectedVertex Class</title>
      ...
      <span class="hideshowall">
        ...
        <span class="details"><button id="buttonHide">Show Summaries</button></span>
            ...
            <p class="classsummary">
                ...
                This holds <a href="../symbols/ForceDirectedLayout.html" class="linkConstructor">ForceDirectedLayout</a>-specific information about <a href="../symbols/Node.html" class="linkConstructor">Node</a>s.<p>This class inherits from <a href="../symbols/LayoutVertex.html" class="linkConstructor">LayoutVertex</a>.
            </p>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class ForceDirectedVertex.">
                <thead>
                        <tr>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class ForceDirectedVertex.">
                    <thead>
                        <tr>
              ...
              <tr id="charge" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the electrical charge for this vertex.<span class="nodetails" id="xpropcharge"><a class="morelink" onclick="hst('propcharge')">More...</a></span> <span class="details" id="propcharge">The default value is NaN.</span>
              ...
              <tr id="forceX" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the cumulative force on the vertex in the X direction.<span class="nodetails" id="xpropforceX"><a class="morelink" onclick="hst('propforceX')">More...</a></span> <span class="details" id="propforceX">The default value is zero.</span>
              ...
              <tr id="forceY" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the cumulative force on the vertex in the Y direction.<span class="nodetails" id="xpropforceY"><a class="morelink" onclick="hst('propforceY')">More...</a></span> <span class="details" id="propforceY">The default value is zero.</span>
              ...
              <tr id="isFixed" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets whether the vertex may be moved by any forces.<span class="nodetails" id="xpropisFixed"><a class="morelink" onclick="hst('propisFixed')">More...</a></span> <span class="details" id="propisFixed">The default value is false.</span>
              ...
              <tr id="mass" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the gravitational mass for this vertex.<span class="nodetails" id="xpropmass"><a class="morelink" onclick="hst('propmass')">More...</a></span> <span class="details" id="propmass">The default value is NaN.</span>
