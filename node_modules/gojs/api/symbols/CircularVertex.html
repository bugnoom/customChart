...
<html>
    <head>
        ...
        <title>GoJS&reg; CircularVertex Class</title>
      ...
      <span class="hideshowall">
        ...
        <span class="details"><button id="buttonHide">Show Summaries</button></span>
            ...
            <p class="classsummary">
                ...
                This holds <a href="../symbols/CircularLayout.html" class="linkConstructor">CircularLayout</a>-specific information about <a href="../symbols/Node.html" class="linkConstructor">Node</a>s.<p>This class inherits from <a href="../symbols/LayoutVertex.html" class="linkConstructor">LayoutVertex</a>.
            </p>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class CircularVertex.">
                <thead>
                        <tr>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class CircularVertex.">
                    <thead>
                        <tr>
              ...
              <tr id="actualAngle" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the value used as the vertex's angle.
              ...
              <tr id="diameter" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the value used as the vertex's diameter.<span class="nodetails" id="xpropdiameter"><a class="morelink" onclick="hst('propdiameter')">More...</a></span> <span class="details" id="propdiameter"></span><div class="details" id="dpropdiameter"><p>By default the value depends on the <a href="../symbols/CircularLayout.html#arrangement" class="linkProperty">CircularLayout.arrangement</a> property.Any computed value is cached, to avoid unnecessary expensive computations.</div>
