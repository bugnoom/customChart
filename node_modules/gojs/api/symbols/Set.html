...
<html>
    <head>
        ...
        <title>GoJS&reg; Set Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class Set.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>There are three possible constructors:Set(),Set(string) where string is a primitive type ('number' or 'string'), orSet(func) where func is a class function/constructor, such as <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a>.<span class="nodetails" id="xconSet"><a class="morelink" onclick="hst('conSet')">More...</a></span> <span class="details" id="conSet"></span>
                            ...
                            <dt class="heading">Parameters:</dt>
                                ...
                                <dt>
                                    ...
                                    <dd>Optional class type (constructor) or a stringdescribing a primitive type, either 'string' or 'number'.</dd>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class Set.">
                    <thead>
                        <tr>
              ...
              <tr id="count" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property is the number of elements in the Set.
              ...
              <tr id="iterator" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets an object that you can use for iterating over the Set.<span class="nodetails" id="xpropiterator"><a class="morelink" onclick="hst('propiterator')">More...</a></span> <span class="details" id="propiterator">The value will be a member of the Set.Typical usage:<pre>  var it = aSet.iterator;  while (it.next()) {    . . . " value: " + it.value . . .  }</pre></span>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class Set.">
                    <thead>
                        <tr>
            ...
            <tr id="add">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Adds a given value to the Set, if not already present.<span class="nodetails" id="xmethadd"><a class="morelink" onclick="hst('methadd')">More...</a></span> <span class="details" id="methadd"></span><div class="details" id="dmethadd"><p>Be careful not to call this method while iterating over the collection.</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dd>The value to add to the Set; must not be null.</dd>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{boolean}</span> true if the value was not already present in the Set; false if it was.</dt>
            ...
            <tr id="addAll">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Adds all of the values of a collection to this Set.<span class="nodetails" id="xmethaddAll"><a class="morelink" onclick="hst('methaddAll')">More...</a></span> <span class="details" id="methaddAll"></span><div class="details" id="dmethaddAll"><p>Be careful not to call this method while iterating over the collection.</div>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{Set.<T>}</span> this Set.</dt>
            ...
            <tr id="clear">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Clears the Set.<span class="nodetails" id="xmethclear"><a class="morelink" onclick="hst('methclear')">More...</a></span> <span class="details" id="methclear">This sets the <a href="../symbols/Set.html#count" class="linkProperty">count</a> to zero.</span><div class="details" id="dmethclear"><p>Be careful not to call this method while iterating over the collection.</div>
            ...
            <tr id="contains">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Returns whether the given value is in this Set.<span class="nodetails" id="xmethcontains"><a class="morelink" onclick="hst('methcontains')">More...</a></span> <span class="details" id="methcontains"></span>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{boolean}</span> Whether or not the value is contained within the Set.</dt>
            ...
            <tr id="containsAll">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Returns true if all of the values of a given collection are in this Set.<span class="nodetails" id="xmethcontainsAll"><a class="morelink" onclick="hst('methcontainsAll')">More...</a></span> <span class="details" id="methcontainsAll"></span>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{Iterable.<T>}</span> <b>coll</b>
                                          
                                      </dt>
                                      <dd>the collection of items to check for.</dd>
            ...
            <tr id="containsAny">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Returns true if any of the values of a given collection are in this Set.<span class="nodetails" id="xmethcontainsAny"><a class="morelink" onclick="hst('methcontainsAny')">More...</a></span> <span class="details" id="methcontainsAny"></span>
            ...
            <tr id="copy">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Makes a shallow copy of this Set.<span class="nodetails" id="xmethcopy"><a class="morelink" onclick="hst('methcopy')">More...</a></span> <span class="details" id="methcopy">The values are not copied,so if they are objects they may continue to be shared with the original Set.</span>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{Set.<T>}</span> The new Set.</dt>
                ...
                <td class="description">
                                ...
                                <!--newp--><p><p>Call the given function on each item in the collection.<span class="nodetails" id="xmetheach"><a class="morelink" onclick="hst('metheach')">More...</a></span> <span class="details" id="metheach"></span>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{Set.<T>}</span> this set itself</dt>
            ...
            <tr id="first">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Returns the first item in the collection, or null if there is none.
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{T|null}</span> This returns null if there are no items in the collection.</dt>
            ...
            <tr id="has">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Returns whether the given value is in this Set.<span class="nodetails" id="xmethhas"><a class="morelink" onclick="hst('methhas')">More...</a></span> <span class="details" id="methhas"></span>
            ...
            <tr id="remove">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Removes a value (if found) from the Set.<span class="nodetails" id="xmethremove"><a class="morelink" onclick="hst('methremove')">More...</a></span> <span class="details" id="methremove"></span><div class="details" id="dmethremove"><p>Be careful not to call this method while iterating over the collection.</div>
            ...
            <tr id="removeAll">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Removes all of the values of a collection from this Set.<span class="nodetails" id="xmethremoveAll"><a class="morelink" onclick="hst('methremoveAll')">More...</a></span> <span class="details" id="methremoveAll"></span><div class="details" id="dmethremoveAll"><p>Be careful not to call this method while iterating over the collection.</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dd>the collection of items to remove.</dd>
            ...
            <tr id="retainAll">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Removes from this Set all items that are not in the given collection.<span class="nodetails" id="xmethretainAll"><a class="morelink" onclick="hst('methretainAll')">More...</a></span> <span class="details" id="methretainAll"></span><div class="details" id="dmethretainAll"><p>Be careful not to call this method while iterating over the collection.</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dd>the collection of items that should be kept in this Set.</dd>
            ...
            <tr id="toArray">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Produces a JavaScript Array from the contents of this Set.
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{Array.<T>}</span> A copy of the Set in Array form.</dt>
            ...
            <tr id="toList">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Converts the Set to a <a href="../symbols/List.html" class="linkConstructor">List</a>.<span class="nodetails" id="xmethtoList"><a class="morelink" onclick="hst('methtoList')">More...</a></span> <span class="details" id="methtoList">Because there is no ordering within a Set,the values in the List may be in any order.</span>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{List.<T>}</span> A copy of the contents of this Set in List form.</dt>
