...
<html>
    <head>
        ...
        <title>GoJS&reg; PanningTool Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class PanningTool.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>You do not normally need to create an instance of this toolbecause one already exists as the <a href="../symbols/ToolManager.html#panningTool" class="linkProperty">ToolManager.panningTool</a>.<span class="nodetails" id="xconPanningTool"><a class="morelink" onclick="hst('conPanningTool')">More...</a></span> <span class="details" id="conPanningTool"></span><div class="details" id="dconPanningTool"><p>The <a href="../symbols/Tool.html#name" class="linkProperty">Tool.name</a> of this tool is "Panning".</div>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class PanningTool.">
                    <thead>
                        <tr>
              ...
              <tr id="bubbles" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets whether panning actions will allowevents to bubble <strong>instead</strong> of panning in the diagram.<span class="nodetails" id="xpropbubbles"><a class="morelink" onclick="hst('propbubbles')">More...</a></span> <span class="details" id="propbubbles"></span><div class="details" id="dpropbubbles"><p>Set this to true to allow mobile devices to scroll the page with panning gestures on the diagram.Otherwise, the panning events will be captured and used to pan inside of the diagram.<p>The default value is false.</div>
                
                </div>
                            </td>
                        </tr>
                    
              <tr id="originalPosition" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property returns the <a href="../symbols/Point.html" class="linkConstructor">Point</a> that was the original value of <a href="../symbols/Diagram.html#position" class="linkProperty">Diagram.position</a> when the panning operation started.
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class PanningTool.">
                    <thead>
                        <tr>
            ...
            <tr id="canStart">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This tool can run when the diagram allows scrolling andthe mouse has been dragged with the left button far enough awayfrom the mouse-down point to avoid being a click.<span class="nodetails" id="xmethcanStart"><a class="morelink" onclick="hst('methcanStart')">More...</a></span> <span class="details" id="methcanStart"></span><div class="details" id="dmethcanStart"><p>This method may be overridden.</div>
            ...
            <tr id="doActivate">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Capture the mouse, change the diagram cursor, and remember the <a href="../symbols/Diagram.html#position" class="linkProperty">Diagram.position</a>.
            ...
            <tr id="doCancel">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Restore the <a href="../symbols/Diagram.html#position" class="linkProperty">Diagram.position</a> to what it was when this tool activated.
            ...
            <tr id="doDeactivate">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Release the mouse and restore the default diagram cursor.
            ...
            <tr id="doMouseMove">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Modify the <a href="../symbols/Diagram.html#position" class="linkProperty">Diagram.position</a> according to how much the mouse has moved.
