...
<html>
    <head>
        ...
        <title>GoJS&reg; Map Class</title>
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                ...
                <td class="description">
                                ...
                                <!--newp--><p><p>Returns the first key/value pair in the collection, or null if there is none.
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{KeyValuePair.<K,V>}</span> This returns null if there are no items in the collection.</dt>
            ...
            <tr id="get">
                <td class="name">
                  ...
                  <div class="attributes">
                    <span class="light">{V|null}</span>
                    
                  </div>
                </td>
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Returns the value associated with a key.<span class="nodetails" id="xmethget"><a class="morelink" onclick="hst('methget')">More...</a></span> <span class="details" id="methget"></span>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{V|null}</span> The value associated with the given key, or null if not present in the Map.</dt>
            ...
            <tr id="getValue">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Returns the value associated with a key.<span class="nodetails" id="xmethgetValue"><a class="morelink" onclick="hst('methgetValue')">More...</a></span> <span class="details" id="methgetValue"></span>
            ...
            <tr id="has">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Returns whether the given key is in this Map.<span class="nodetails" id="xmethhas"><a class="morelink" onclick="hst('methhas')">More...</a></span> <span class="details" id="methhas"></span>
            ...
            <tr id="remove">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Removes a key (if found) from the Map.<span class="nodetails" id="xmethremove"><a class="morelink" onclick="hst('methremove')">More...</a></span> <span class="details" id="methremove"></span><div class="details" id="dmethremove"><p>Be careful not to call this method while iterating over the collection.</div>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{boolean}</span> true if the key was found and removed, false otherwise.</dt>
            ...
            <tr id="set">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Adds a key-value association to the Map, or replaces the value associated with the keyif the key was already present in the map.<span class="nodetails" id="xmethset"><a class="morelink" onclick="hst('methset')">More...</a></span> <span class="details" id="methset"></span><div class="details" id="dmethset"><p>Be careful not to call this method while iterating over the collection.</div>
            ...
            <tr id="toArray">
                <td class="name">
                  ...
                  <div class="attributes">
                    <span class="light">{Array.<KeyValuePair.<K,V>>}</span>
                    
                  </div>
                </td>
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Produces a JavaScript Array of key/value pair objects from the contents of this Map.
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{Array.<KeyValuePair.<K,V>>}</span> A copy of the Map in Array form,each element being an Object with 'key' and 'value' properties.</dt>
            ...
            <tr id="toKeySet">
                <td class="name">
                  ...
                  <div class="attributes">
                    <span class="light">{MapKeySet.<K,V>}</span>
                    
                  </div>
                </td>
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Produces a <a href="../symbols/Set.html" class="linkConstructor">Set</a> that provides a read-only view onto the keys of this Map.<span class="nodetails" id="xmethtoKeySet"><a class="morelink" onclick="hst('methtoKeySet')">More...</a></span> <span class="details" id="methtoKeySet">The collection of keys is not copied.</span>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{MapKeySet.<K,V>}</span> </dt>
