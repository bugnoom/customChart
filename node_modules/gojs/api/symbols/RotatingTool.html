...
<html>
    <head>
        ...
        <title>GoJS&reg; RotatingTool Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class RotatingTool.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>You do not normally need to create an instance of this toolbecause one already exists as the <a href="../symbols/ToolManager.html#rotatingTool" class="linkProperty">ToolManager.rotatingTool</a>, which you can modify.<span class="nodetails" id="xconRotatingTool"><a class="morelink" onclick="hst('conRotatingTool')">More...</a></span> <span class="details" id="conRotatingTool"></span><div class="details" id="dconRotatingTool"><p>The <a href="../symbols/Tool.html#name" class="linkProperty">Tool.name</a> of this tool is "Rotating".</div>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class RotatingTool.">
                    <thead>
                        <tr>
              ...
              <tr id="adornedObject" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> that is being rotated.<span class="nodetails" id="xpropadornedObject"><a class="morelink" onclick="hst('propadornedObject')">More...</a></span> <span class="details" id="propadornedObject">This may be the same object as the selected <a href="../symbols/Part.html" class="linkConstructor">Part</a> or it may be contained within that Part.</span><div class="details" id="dpropadornedObject"><p>This property is also settable, but should only be set when overriding functionsin RotatingTool, and not during normal operation.</div>
              ...
              <tr id="handle" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property returns the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> that is the tool handle being dragged by the user.<span class="nodetails" id="xprophandle"><a class="morelink" onclick="hst('prophandle')">More...</a></span> <span class="details" id="prophandle">This will be contained by an <a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a> whose category is "RotatingTool".Its <a href="../symbols/Adornment.html#adornedObject" class="linkProperty">Adornment.adornedObject</a> is the same as the <a href="../symbols/RotatingTool.html#adornedObject" class="linkProperty">adornedObject</a>.</span>
              ...
              <tr id="handleArchetype" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets a small GraphObject that is copied as a rotation handle for the selected part.<span class="nodetails" id="xprophandleArchetype"><a class="morelink" onclick="hst('prophandleArchetype')">More...</a></span> <span class="details" id="prophandleArchetype">By default this is a <a href="../symbols/Shape.html" class="linkConstructor">Shape</a> that is a small yellow circle.Setting this property does not raise any events.</span><div class="details" id="dprophandleArchetype"><p>Here is an example of changing the default handle to be green "X":<pre class="javascript">  myDiagram.toolManager.rotatingTool.handleArchetype =    $(go.Shape, "XLine",      { width: 8, height: 8, stroke: "green", fill: "transparent" });</pre><p>This property is ignored when a custom rotating Adornment is specified as the <a href="../symbols/Part.html#rotateAdornmentTemplate" class="linkProperty">Part.rotateAdornmentTemplate</a>.</div>
              ...
              <tr id="originalAngle" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property returns the angle that was the original value of the <a href="../symbols/GraphObject.html#angle" class="linkProperty">GraphObject.angle</a>of the GraphObject that is being rotated.
                
                </div>
                            </td>
                        </tr>
                    
              <tr id="snapAngleEpsilon" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the the closeness to a desired angle at which the angle is "snapped to".<span class="nodetails" id="xpropsnapAngleEpsilon"><a class="morelink" onclick="hst('propsnapAngleEpsilon')">More...</a></span> <span class="details" id="propsnapAngleEpsilon"></span><div class="details" id="dpropsnapAngleEpsilon"><p>The default value is 2 degrees, meaning that any angle within 2 degreesof a multiple of the <a href="../symbols/RotatingTool.html#snapAngleMultiple" class="linkProperty">snapAngleMultiple</a> automaticallysnaps to that multiple.Values are limited to half of the <a href="../symbols/RotatingTool.html#snapAngleMultiple" class="linkProperty">snapAngleMultiple</a>;such values restrict user selected angles only to exact multiples of<a href="../symbols/RotatingTool.html#snapAngleMultiple" class="linkProperty">snapAngleMultiple</a> -- no other angles between them.Setting this property does not raise any events.</div>
                
                </div>
                            </td>
                        </tr>
                    
              <tr id="snapAngleMultiple" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the preferred angles for the selected object.<span class="nodetails" id="xpropsnapAngleMultiple"><a class="morelink" onclick="hst('propsnapAngleMultiple')">More...</a></span> <span class="details" id="propsnapAngleMultiple"></span><div class="details" id="dpropsnapAngleMultiple"><p>The default value is 45 degrees, meaning that angles that are multiplesof 45 degrees are automatically preferred, if the actual angle isclose to that multiple.The closeness is determined by the <a href="../symbols/RotatingTool.html#snapAngleEpsilon" class="linkProperty">snapAngleEpsilon</a> property.A value of zero for <a href="../symbols/RotatingTool.html#snapAngleMultiple" class="linkProperty">snapAngleMultiple</a> results in no snapping at all.Setting this property does not raise any events.</div>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class RotatingTool.">
                    <thead>
                        <tr>
            ...
            <tr id="canStart">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This tool may run when there is a mouse-down event on a rotate handle,the diagram is not read-only and it allows rotation,the left mouse button is being used,and this tool's adornment's rotate handle is at the current mouse point.<span class="nodetails" id="xmethcanStart"><a class="morelink" onclick="hst('methcanStart')">More...</a></span> <span class="details" id="methcanStart"></span><div class="details" id="dmethcanStart"><p>This method may be overridden.</div>
            ...
            <tr id="computeRotate">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Compute the new angle given a point.<span class="nodetails" id="xmethcomputeRotate"><a class="morelink" onclick="hst('methcomputeRotate')">More...</a></span> <span class="details" id="methcomputeRotate"> If the Shift key is pressed, this method ignores the <a href="../symbols/RotatingTool.html#snapAngleMultiple" class="linkProperty">snapAngleMultiple</a> and <a href="../symbols/RotatingTool.html#snapAngleEpsilon" class="linkProperty">snapAngleEpsilon</a>.</span><div class="details" id="dmethcomputeRotate"><p>If the angle is close (by <a href="../symbols/RotatingTool.html#snapAngleEpsilon" class="linkProperty">snapAngleEpsilon</a> degrees)to a multiple of <a href="../symbols/RotatingTool.html#snapAngleMultiple" class="linkProperty">snapAngleMultiple</a> degrees,make it exactly that multiple.<p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{number}</span> the new angle, in degrees.</dt>
            ...
            <tr id="doActivate">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Capture the mouse, remember the original <a href="../symbols/GraphObject.html#angle" class="linkProperty">GraphObject.angle</a>,and start a transaction.
            ...
            <tr id="doCancel">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Restore the original <a href="../symbols/GraphObject.html#angle" class="linkProperty">GraphObject.angle</a> of the adorned object.
            ...
            <tr id="doMouseMove">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Call <a href="../symbols/RotatingTool.html#rotate" class="linkMethod">rotate</a> with a new angle determined by the current mouse point.<span class="nodetails" id="xmethdoMouseMove"><a class="morelink" onclick="hst('methdoMouseMove')">More...</a></span> <span class="details" id="methdoMouseMove">This determines the new angle by calling <a href="../symbols/RotatingTool.html#computeRotate" class="linkMethod">computeRotate</a>.</span>
            ...
            <tr id="doMouseUp">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Call <a href="../symbols/RotatingTool.html#rotate" class="linkMethod">rotate</a> with an angle based on the most recent mouse point,commit the transaction, and raise the "PartRotated" <a href="../symbols/DiagramEvent.html" class="linkConstructor">DiagramEvent</a>.
            ...
            <tr id="rotate">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Change the angle of the selected part's <a href="../symbols/Part.html#rotateObject" class="linkProperty">Part.rotateObject</a>.<span class="nodetails" id="xmethrotate"><a class="morelink" onclick="hst('methrotate')">More...</a></span> <span class="details" id="methrotate">This modifies its <a href="../symbols/GraphObject.html#angle" class="linkProperty">GraphObject.angle</a>.</span><div class="details" id="dmethrotate"><p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{number}</span> <b>newangle</b>
            ...
            <tr id="updateAdornments">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Show an <a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a> with a rotate handle at a point to the side of the adorned objectif the part is selected and visible and if <a href="../symbols/Part.html#canRotate" class="linkMethod">Part.canRotate</a>() is true.<span class="nodetails" id="xmethupdateAdornments"><a class="morelink" onclick="hst('methupdateAdornments')">More...</a></span> <span class="details" id="methupdateAdornments"></span><div class="details" id="dmethupdateAdornments"><p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
