...
<html>
    <head>
        ...
        <title>GoJS&reg; ContextMenuTool Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class ContextMenuTool.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>You do not normally need to create an instance of this toolbecause one already exists as the <a href="../symbols/ToolManager.html#contextMenuTool" class="linkProperty">ToolManager.contextMenuTool</a>, which you can modify.<span class="nodetails" id="xconContextMenuTool"><a class="morelink" onclick="hst('conContextMenuTool')">More...</a></span> <span class="details" id="conContextMenuTool"></span><div class="details" id="dconContextMenuTool"><p>The <a href="../symbols/Tool.html#name" class="linkProperty">Tool.name</a> of this tool is "ContextMenu".</div>
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class ContextMenuTool.">
                    <thead>
                        <tr>
              ...
              <tr id="currentContextMenu" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the currently showing context menu, or null if there is none.<span class="nodetails" id="xpropcurrentContextMenu"><a class="morelink" onclick="hst('propcurrentContextMenu')">More...</a></span> <span class="details" id="propcurrentContextMenu">This is typically only set in <a href="../symbols/ContextMenuTool.html#showContextMenu" class="linkMethod">showContextMenu</a> and not by the user.It is also typically set to null in <a href="../symbols/ContextMenuTool.html#hideContextMenu" class="linkMethod">hideContextMenu</a>.</span>
              ...
              <tr id="currentObject" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> found at the mouse point that has a context menu.<span class="nodetails" id="xpropcurrentObject"><a class="morelink" onclick="hst('propcurrentObject')">More...</a></span> <span class="details" id="propcurrentObject">This property remembers the result returned by <a href="../symbols/ContextMenuTool.html#findObjectWithContextMenu" class="linkMethod">findObjectWithContextMenu</a> if it is a GraphObject.This value is passed to <a href="../symbols/ContextMenuTool.html#showContextMenu" class="linkMethod">showContextMenu</a> as the second argument.The value will be null if the context menu is for the diagram rather than for a particular GraphObject.</span>
                
                </div>
                            </td>
                        </tr>
                    
              <tr id="defaultTouchContextMenu" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the HTMLInfo or Adornment that acts as the default touch context menu.<span class="nodetails" id="xpropdefaultTouchContextMenu"><a class="morelink" onclick="hst('propdefaultTouchContextMenu')">More...</a></span> <span class="details" id="propdefaultTouchContextMenu">On touch devices, this context menu will appear even there is no context menu defined.</span><div class="details" id="dpropdefaultTouchContextMenu"><p>You can disable this functionality by setting this property to null.<p>By default shows a set of HTML elements acting as a context menu.</div>
                
                </div>
                            </td>
                        </tr>
                    
              <tr id="mouseDownPoint" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property returns the original mouse-down point in document coordinates.
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class ContextMenuTool.">
                    <thead>
                        <tr>
            ...
            <tr id="doActivate">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Do nothing, activation is special and relies on doMouseUp
            ...
            <tr id="doMouseDown">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Activate this but also execute the normal behavior that would happen on a mouse-upif this tool is in the <a href="../symbols/ToolManager.html#mouseDownTools" class="linkProperty">ToolManager.mouseDownTools</a> list.
            ...
            <tr id="doMouseMove">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Handle mouse-enter, mouse-over, and mouse-leave events, as well as tooltips.
            ...
            <tr id="doMouseUp">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>If there is something found by <a href="../symbols/ContextMenuTool.html#findObjectWithContextMenu" class="linkMethod">findObjectWithContextMenu</a>,call <a href="../symbols/ContextMenuTool.html#showContextMenu" class="linkMethod">showContextMenu</a> with that object's <a href="../symbols/GraphObject.html#contextMenu" class="linkProperty">GraphObject.contextMenu</a>or the <a href="../symbols/Diagram.html#contextMenu" class="linkProperty">Diagram.contextMenu</a>.<span class="nodetails" id="xmethdoMouseUp"><a class="morelink" onclick="hst('methdoMouseUp')">More...</a></span> <span class="details" id="methdoMouseUp"></span><div class="details" id="dmethdoMouseUp"><p>Once a context menu is being shown,if a click occurs on a part of the context menu, call <a href="../symbols/Tool.html#standardMouseClick" class="linkMethod">Tool.standardMouseClick</a>.Otherwise if the click occurs elsewhere, just stop this tool.Unlike most tools, the first mouse-up should not stop this tool.</div>
            ...
            <tr id="findObjectWithContextMenu">
                <td class="name">
                  ...
                  <div class="attributes">
                    <span class="light">{<a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a>|<a href="../symbols/Diagram.html" class="linkConstructor">Diagram</a>}</span>
                    
                  </div>
                </td>
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Find a <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> at the current mouse point with a <a href="../symbols/GraphObject.html#contextMenu" class="linkProperty">GraphObject.contextMenu</a>,or return the <a href="../symbols/Diagram.html" class="linkConstructor">Diagram</a> if there is a <a href="../symbols/Diagram.html#contextMenu" class="linkProperty">Diagram.contextMenu</a>.<span class="nodetails" id="xmethfindObjectWithContextMenu"><a class="morelink" onclick="hst('methfindObjectWithContextMenu')">More...</a></span> <span class="details" id="methfindObjectWithContextMenu"></span><div class="details" id="dmethfindObjectWithContextMenu"><p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dd>Optional GraphObject with which to start searching for a context menu.If null, the Diagram will be used. If no argument is specified, this method will look for an object at the current mouse point.</dd>
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{<a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a>|<a href="../symbols/Diagram.html" class="linkConstructor">Diagram</a>}</span> something with a <code>contextMenu</code>,or null if nothing can be found with a context menu at the current mouse point.</dt>
            ...
            <tr id="hideContextMenu">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Hide any context menu.<span class="nodetails" id="xmethhideContextMenu"><a class="morelink" onclick="hst('methhideContextMenu')">More...</a></span> <span class="details" id="methhideContextMenu"></span><div class="details" id="dmethhideContextMenu"><p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                ...
                <td class="description">
                                ...
                                <!--newp--><p><p>This is called by <a href="../symbols/ContextMenuTool.html#showContextMenu" class="linkMethod">showContextMenu</a> to position the context menu within the viewport.<span class="nodetails" id="xmethpositionContextMenu"><a class="morelink" onclick="hst('methpositionContextMenu')">More...</a></span> <span class="details" id="methpositionContextMenu">It normally goes just below the cursor.But if the mouse is too close to the right edge or the bottom edge of the viewport,it is positioned left and/or above the cursor.</span><div class="details" id="dmethpositionContextMenu"><p>This method only operates if the context menu, an <a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a>, does not have a <a href="../symbols/Adornment.html#placeholder" class="linkProperty">Adornment.placeholder</a>.When there is a <a href="../symbols/Placeholder.html" class="linkConstructor">Placeholder</a> in the context menu, that Adornment is automatically positionedso that the Placeholder is positioned at the adorned object, the second argument to this method.<p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.<p>If you override this method to position the context menu,the context menu has already been measured but not arranged,so you can use its <a href="../symbols/GraphObject.html#measuredBounds" class="linkProperty">GraphObject.measuredBounds</a> width and heightbut not its <a href="../symbols/GraphObject.html#actualBounds" class="linkProperty">GraphObject.actualBounds</a>.</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{<a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a>}</span> <b>contextmenu</b>
                                      ...
                                      <dd>The <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> getting the context menu,or null if the context menu is for the diagram background.</dd>
            ...
            <tr id="showContextMenu">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Show an <a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a> or <a href="../symbols/HTMLInfo.html" class="linkConstructor">HTMLInfo</a> as a context menu.<span class="nodetails" id="xmethshowContextMenu"><a class="morelink" onclick="hst('methshowContextMenu')">More...</a></span> <span class="details" id="methshowContextMenu"></span><div class="details" id="dmethshowContextMenu"><p>For <a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a> context menus: If the object's containing <a href="../symbols/Part.html" class="linkConstructor">Part</a> is data-bound,set the contextmenu's <code>Part.data</code> to the same value.The <a href="../symbols/Adornment.html#adornedObject" class="linkProperty">Adornment.adornedObject</a> property is set to the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> for which the menu is being shown.<p>This method sets the <a href="../symbols/ContextMenuTool.html#currentContextMenu" class="linkProperty">currentContextMenu</a>.<p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a> for how to override methods and how to call this base method.</div>
                                  ...
                                  <dt class="heading">Parameters:</dt>
                                      ...
                                      <dt>
                                          <span class="light fixedFont">{<a href="../symbols/Adornment.html" class="linkConstructor">Adornment</a>|<a href="../symbols/HTMLInfo.html" class="linkConstructor">HTMLInfo</a>}</span> <b>contextmenu</b>
                                      ...
                                      <dd>the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> for which the context menu is being shown;  this is null if the contextmenu is being shown for the diagram background.</dd>
            ...
            <tr id="showDefaultContextMenu">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This is the <a href="../symbols/HTMLInfo.html#show" class="linkProperty">HTMLInfo.show</a> method for the <a href="../symbols/ContextMenuTool.html#defaultTouchContextMenu" class="linkProperty">defaultTouchContextMenu</a>.<span class="nodetails" id="xmethshowDefaultContextMenu"><a class="morelink" onclick="hst('methshowDefaultContextMenu')">More...</a></span> <span class="details" id="methshowDefaultContextMenu"></span><div class="details" id="dmethshowDefaultContextMenu"><p>If the object's containing <a href="../symbols/Part.html" class="linkConstructor">Part</a> is data-bound,set the contextmenu's <code>Part.data</code> to the same value.The <a href="../symbols/Adornment.html#adornedObject" class="linkProperty">Adornment.adornedObject</a> property is set to the <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a>for which the menu is being shown.<p>This method may be overridden.Please read the Introduction page on <a href="../../intro/extensions.html">Extensions</a>for how to override methods and how to call this base method.</div>
