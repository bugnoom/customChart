...
<html>
    <head>
        ...
        <title>GoJS&reg; ActionTool Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class ActionTool.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>You do not normally need to create an instance of this toolbecause one already exists as the <a href="../symbols/ToolManager.html#actionTool" class="linkProperty">ToolManager.actionTool</a>.<span class="nodetails" id="xconActionTool"><a class="morelink" onclick="hst('conActionTool')">More...</a></span> <span class="details" id="conActionTool"></span><div class="details" id="dconActionTool"><p>The <a href="../symbols/Tool.html#name" class="linkProperty">Tool.name</a> of this tool is "Action".</div>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class ActionTool.">
                    <thead>
                        <tr>
            ...
            <tr id="canStart">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This tool can run when there is a mouse-down on an object with <a href="../symbols/GraphObject.html#isActionable" class="linkProperty">GraphObject.isActionable</a> trueor if the object is within a <a href="../symbols/Panel.html" class="linkConstructor">Panel</a> that "isActionable".<span class="nodetails" id="xmethcanStart"><a class="morelink" onclick="hst('methcanStart')">More...</a></span> <span class="details" id="methcanStart"></span><div class="details" id="dmethcanStart"><p>This method may be overridden.</div>
            ...
            <tr id="doCancel">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Call the <a href="../symbols/GraphObject.html#actionCancel" class="linkProperty">GraphObject.actionCancel</a> event if defined on the current object.
            ...
            <tr id="doMouseDown">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>If there is a <a href="../symbols/GraphObject.html" class="linkConstructor">GraphObject</a> found with <a href="../symbols/GraphObject.html#isActionable" class="linkProperty">GraphObject.isActionable</a> set to true,call that object's <a href="../symbols/GraphObject.html#actionDown" class="linkProperty">GraphObject.actionDown</a> event, if it exists.
            ...
            <tr id="doMouseMove">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>If this tool is active call <a href="../symbols/GraphObject.html#actionMove" class="linkProperty">GraphObject.actionMove</a>, if it exists, on the active object.
            ...
            <tr id="doMouseUp">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Calls the <a href="../symbols/GraphObject.html#actionUp" class="linkProperty">GraphObject.actionUp</a> event if defined, then effectively calls<a href="../symbols/Tool.html#standardMouseClick" class="linkMethod">Tool.standardMouseClick</a> to perform the normal click behaviors,and then stops this tool.
