...
<html>
    <head>
        ...
        <title>GoJS&reg; Transaction Class</title>
...
<!-- ============================== constructor summary ==================== -->
        ...
        <h2 id="constructor" class="summaryCaption"> Constructor <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <table class="summaryTable table table-bordered table-condensed" summary="A summary of the constructor documented in the class Transaction.">
                <thead>
                        <tr>
              ...
              <td class="description">
                            ...
                            <!--newp--><p><p>Construct an object holding an empty list of <a href="../symbols/ChangedEvent.html" class="linkConstructor">ChangedEvent</a>sand no <a href="../symbols/Transaction.html#name" class="linkProperty">name</a>.
...
<!-- ============================== properties summary ===================== -->
        ...
        <div class="table-responsive">
        <table class="summaryTable table table-bordered table-condensed" summary="A summary of the properties documented in the class Transaction.">
                    <thead>
                        <tr>
              ...
              <tr id="changes" >
                ...
                <td class="name">
                  ...
                  <div class="attributes">
                    <span class="light">{List.<ChangedEvent>}</span>
                ...
                <div class="description">
                <!--newp <p> -->
                <p>This read-only property returns the list of <a href="../symbols/ChangedEvent.html" class="linkConstructor">ChangedEvent</a>s.<span class="nodetails" id="xpropchanges"><a class="morelink" onclick="hst('propchanges')">More...</a></span> <span class="details" id="propchanges">The changes are stored in order of occurrence.</span><div class="details" id="dpropchanges"><p>You should not modify this list.</div>
              ...
              <tr id="isComplete" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets whether we can add more <a href="../symbols/ChangedEvent.html" class="linkConstructor">ChangedEvent</a>s to this list of changes.<span class="nodetails" id="xpropisComplete"><a class="morelink" onclick="hst('propisComplete')">More...</a></span> <span class="details" id="propisComplete">This is initially false.It is set to true by <a href="../symbols/UndoManager.html#commitTransaction" class="linkMethod">UndoManager.commitTransaction</a> and <a href="../symbols/UndoManager.html#rollbackTransaction" class="linkMethod">UndoManager.rollbackTransaction</a>.</span>
              ...
              <tr id="name" >
                ...
                <div class="description">
                <!--newp <p> -->
                <p>Gets or sets the transaction name for this collection of changes.<span class="nodetails" id="xpropname"><a class="morelink" onclick="hst('propname')">More...</a></span> <span class="details" id="propname">This is set by a top-level call to <a href="../symbols/UndoManager.html#commitTransaction" class="linkMethod">UndoManager.commitTransaction</a>.</span>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
                <div class="table-responsive">
                <table class="summaryTable table table-bordered table-condensed" summary="A summary of the methods documented in the class Transaction.">
                    <thead>
                        <tr>
            ...
            <tr id="canRedo">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This predicate returns true if you can call <a href="../symbols/Transaction.html#redo" class="linkMethod">redo</a>,namely when <a href="../symbols/Transaction.html#isComplete" class="linkProperty">isComplete</a> is true.
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{boolean}</span> true if ready for <a href="../symbols/Transaction.html#redo" class="linkMethod">redo</a> to be called.</dt>
            ...
            <tr id="canUndo">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>This predicate returns true if you can call <a href="../symbols/Transaction.html#undo" class="linkMethod">undo</a>,namely when <a href="../symbols/Transaction.html#isComplete" class="linkProperty">isComplete</a> is true.
                                  ...
                                  <dt class="heading">Returns:</dt>
                                      ...
                                      <dt><span class="light fixedFont">{boolean}</span> true if ready for <a href="../symbols/Transaction.html#undo" class="linkMethod">undo</a> to be called.</dt>
            ...
            <tr id="clear">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Clear all of the saved changes.
            ...
            <tr id="redo">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Re-perform these changes after an <a href="../symbols/Transaction.html#undo" class="linkMethod">undo</a>.<span class="nodetails" id="xmethredo"><a class="morelink" onclick="hst('methredo')">More...</a></span> <span class="details" id="methredo">This is normally called only by the <a href="../symbols/UndoManager.html" class="linkConstructor">UndoManager</a>.<a href="../symbols/Transaction.html#canRedo" class="linkMethod">canRedo</a> must be true for this method to have any effect.</span>
            ...
            <tr id="undo">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Undo all of the changes, in reverse order.<span class="nodetails" id="xmethundo"><a class="morelink" onclick="hst('methundo')">More...</a></span> <span class="details" id="methundo">This is normally called only by the <a href="../symbols/UndoManager.html" class="linkConstructor">UndoManager</a>.<a href="../symbols/Transaction.html#canUndo" class="linkMethod">canUndo</a> must be true for this method to have any effect.</span>
