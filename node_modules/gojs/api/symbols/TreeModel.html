...
<html>
    <head>
        ...
        <title>GoJS&reg; TreeModel Class</title>
...
<!-- ============================== methods summary ======================== -->
        ...
        <h2 class="summaryCaption">Method <span class="nodetails"> Summary</span><span class="details"> Details</span></h2>
            ...
            <tr id="setParentLinkCategoryForNodeData">
                ...
                <td class="description">
                                <div class="description">
                                <!--newp--><p><p>Change the category for the parent link of a given child node data, a string naming the link templatethat the <a href="../symbols/Diagram.html" class="linkConstructor">Diagram</a> should use to represent the link.<span class="nodetails" id="xmethsetParentLinkCategoryForNodeData"><a class="morelink" onclick="hst('methsetParentLinkCategoryForNodeData')">More...</a></span> <span class="details" id="methsetParentLinkCategoryForNodeData"></span><div class="details" id="dmethsetParentLinkCategoryForNodeData"><p>Changing the link template will cause any existing <a href="../symbols/Link.html" class="linkConstructor">Link</a>to be removed from the <a href="../symbols/Diagram.html" class="linkConstructor">Diagram</a> and replaced with a new <a href="../symbols/Link.html" class="linkConstructor">Link</a>created by copying the new link template and applying any data-bindings.Note that the new template must be an instance of the same class as the original link.Thus one cannot change the category of a link from an instance of <a href="../symbols/Link.html" class="linkConstructor">Link</a>to an instance of a subclass of Link, nor vice-versa.</div>
